...
* мом активный, спавнит область, в которой вампиризм исчезает быстрее, если не стоит в ней герой
* шмотки на онхит эффекты, собираются вместе: -атакспид, +кд, -броня, -магрезист
* криты и магкриты 
* себе скорость атаки и -броня
* активка долгая сильная тычка
* активка джакиро (двойная слабая тычка) 
* шанс на доп атаки ренжевикам / взрывы на тычках
* с перекупа дропается рецепт на рандомный эффект с тычки
* октарин
* маг криты (по кнопке)