    ...
    entries = {
        ...
        d_dreamturnin = {
            ...
            conditions = {
                ...
                { trigger = "trigger_black_creep_2", npc = "npc_dream",       type = "trigger" },
            },
        },
        d_epskillers = {
            priority = 0,
        ...
        d_greenfightagain = {
            ...
            conditions = {
                ...
                { ent_var = "beaten",   value = { false }, npc = "npc_green", type = "ent_var" },
            },
        },
        d_greenfirstmet = {
            priority = 0,
            conditions = {
                { interact = "npc_green",     type = "interact" },
                { ent_var = "first_met_global", value = { true }, npc = "npc_green", type = "ent_var" },
            },
        },
        d_greenlose = {
            priority = 0,
            conditions = {
                { beat = "npc_green", value = false, type = "beat" },
            },
        },
        d_greenwin = {
            priority = 0,
            conditions = {
                { beat = "npc_green", value = true, type = "beat" },
            },
        },
        d_guideact2 = {
            priority = 0,
...
Спасибо, спасибо!! Ты реально оу джи, кекс! Ты лучший!!]],
        ...
        d_leaderagain1 = {
            text =
            [[Чтобы открыть проход в Коралловый лес, подойди поближе к двери и произнеси заклинание вслух: "Stringus Colapsus".]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
Здравствуй, Алекс.]],
        ...
        d_leaderpass3 = {
            text = [[Заклинание от врат в Искажённый лес: "Logarifmus solvus".]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
That was dope, youre feeling me, yeah]],
        ...
        d_xavieryes = {
            text =
            [[You showed yourself clearly, um, like youre my hood bro now. I'm glad that, that i can continue my work here, yeah.]],
            speaker = [[Xaviersobased]],
            npc = "npc_xavier",
            choices = {
                {
...
Ну вот... Мне никогда не стать нигером...]],
        ...
        d_nu_ladno = {
            text =
            [[А ещё, дверь, ведущая к монстру, что поглотил часть ключа, находится в Искажённом лесу. Самом страшном месте, после Пустоши конечно. Держи заклинание от врат в этот лес: "Logarifmus solvus".]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
Нееет, я пожалуй тут останусь... И давай, чтоб ты не рисковал, я тебе за 140 отдам, а?]],
        ...
        d_tam_za_dveru_sluchajno_ne_korallovyj_les = {
            text =
            [[Да. Чтобы открыть её, подойди поближе и произнеси заклинание вслух: "Stringus Colapsus". Будет отлично, если сможешь заодно освободить и эти территории.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
