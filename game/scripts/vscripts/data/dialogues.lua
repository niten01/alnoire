...
return {
    entries = {
        ...
        d_untitled_passage_46mergedact3 = {
            priority = 0,
            conditions = {
                { interact = "npc_dream", type = "interact" },
                { questID = "q_ghetto",   status = QuestStatus.ACTIVE, step = { 2 }, type = "quest" },
        ...
        d_untitled_passagemergedact4 = {
            priority = 0,
            conditions = {
                { beat = "npc_derek", type = "beat" },
            },
        },
        d_untitled_passage_67mergedact4 = {
            priority = 0,
            conditions = {
        ...
        d_untitled_passage_69mergedact4 = {
            priority = 0,
            conditions = {
                { interact = "npc_wasteland", type = "interact" },
            },
        },
        d_untitled_passage_70mergedact4 = {
            priority = 0,
            conditions = {
                { trigger = "trigger_boss_fight_1", npc = "npc_derek", type = "trigger" },
            },
        },
        d_untitled_passage_71mergedact4 = {
            priority = 0,
            conditions = {
                { trigger = "trigger_boss_fight_1", npc = "npc_derek", type = "trigger" },
        ...
        d_untitled_passage_72mergedact4 = {
            priority = 0,
            conditions = {
                { beat = "npc_derek", type = "beat" },
            },
        },
        d_untitled_passage_73mergedact4 = {
            priority = 0,
            conditions = {
                { beat = "npc_derek", type = "beat" },
            },
        },
        d_untitled_passage_74mergedact4 = {
            priority = 0,
            conditions = {
                { trigger = "trigger_boss_fight_2", npc = "npc_george", type = "trigger" },
            },
        },
        d_untitled_passage_75mergedact4 = {
            priority = 0,
            conditions = {
                { beat = "npc_george", type = "beat" },
            },
        },
        d_untitled_passage_76mergedact4 = {
            priority = 0,
            conditions = {
                { beat = "npc_george", type = "beat" },
            },
        },
        d_untitled_passage_77mergedact4 = {
            priority = 0,
            conditions = {
                { interact = "npc_george", type = "interact" },
            },
        },
        d_untitled_passage_78mergedact4 = {
            priority = 0,
            conditions = {
                { trigger = "trigger_boss_fight_2", npc = "npc_george", type = "trigger" },
        ...
        d_untitled_passage_79mergedact4 = {
            priority = 0,
            conditions = {
                { interact = "npc_tormentor",   type = "interact" },
        ...
        d_untitled_passage_80mergedact4 = {
            priority = 0,
            conditions = {
        ...
        d_untitled_passage_81mergedact4 = {
            priority = 0,
            conditions = {
        ...
        d_untitled_passage_82mergedact4 = {
            priority = 0,
            conditions = {
        ...
        d_untitled_passage_83mergedact4 = {
            priority = 0,
            conditions = {
        ...
        d_untitled_passage_84mergedact4 = {
            priority = 0,
            conditions = {
                { questID = "q_main_quest_act_4", status = QuestStatus.COMPLETED, type = "quest" },
        ...
        d_untitled_passage_85mergedact4 = {
            priority = 0,
            conditions = {
                { questID = "q_main_quest_act_4", status = QuestStatus.COMPLETED, type = "quest" },
            ...
            choices = {
                {
                    ...
                    next = nil,
                    actions = {
                        { target = "talk", fight_start = "npc_derek", type = "fight_start" },
                    },
                },
            },
        },
            ...
            choices = {
                {
                    ...
                    next = nil,
                    actions = {
                        { target = "talk", fight_start = "npc_george", type = "fight_start" },
                    },
                },
            },
        },
            ...
            choices = {
                {
                    ...
                    next = nil,
                    actions = {
                        { target = "kill", fight_start = "npc_derek", type = "fight_start" },
                    },
                },
            },
        },
...
Может ты всё-таки развернёшься и пойдешь домой? В жизни есть много прекрасного, я больше не хочу кого-либо лишать возможности наслаждаться ею. Не хочу лишать твоих близких тебя.]],
        ...
        d_mozhet_pogovorim_prosto = {
            text =
            [[ПРОДОЛЖАЙ МЕНЯ ВЕСЕЛИТЬ, ШУТ. Я ХОЧУ ЕЩЁ! СЕЙЧАС ВСПОЛЫХНУ, НЕ ПРЕДСТАВЛЯЕШЬ СКОЛЬКО Я ТОМИЛСЯ ЗДЕСЬ. ПОРА ПОКАЗАТЬ, ПОЧЕМУ МОЙ СТАТУС - БОГОПОДОБНЫЙ.]],
            speaker = [[Пропавший Король]],
            npc = "npc_george",
            choices = {
                {
