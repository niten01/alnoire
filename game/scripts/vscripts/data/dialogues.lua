...
d_i2 = {
text = [[Там обитает Зверь Пустоши, его волосатые ноги меня просто в землю втопчат... Нет ни одного существа, кто ему ровня. Радует, что он не нападает, а только обороняется...]],
speaker = [[Человек-усач]],
npc = "npc_mustache",
choices = {
{
