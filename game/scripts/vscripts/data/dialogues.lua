...
Вижу по твоим глазам, ты как я! Хочешь испытаний, хочешь проверить себя!]],
            speaker = [[Человек-усач]],
            npc = "npc_mustache",
            choices = {
                {
...
Невероятно!]],
        ...
        d_poteret_emu_nosik = {
            text =
            [[*Подойдя поближе, ты замечаешь, что его нос сверкает, словно заолотой слиток. Похоже подобное желание приходило в голову многим. Ты начинаешь смачно тереть его нос, прям втирать. Он всё ещё неподвижно наблюдает, но, опустив брови, его взгляд становится более сердитым.*]],
            speaker = [[Зелёный]],
            npc = "npc_green",
            choices = {
                {
...
Хм... Хорошо. Возможно, ты и есть тот, кто должен был оказаться на моём месте.]],
        ...
        d_dopustim_a_zachem_pozval_menya_to = {
            text =
            [[Ты меня поразил, Алекс. Ты не только начал помогать горожанам, так и спас всех от участи, которая будет пострашней гибели. Благодарю от имени всего Королевтсва.
...
Так уж и быть... Ради твоего дедушки - 50 золота.]],
        ...
        d_eto_nepravilnyj_otvet = {
            text =
            [[Ты этого даже без меня не смог понять... Таким пустоголовым ничтожествам нету места в Скрытой деревне. Позволь спасти тебя от страданий...]],
            speaker = [[Крип-гений]],
            npc = "npc_genius",
            choices = {
                {
