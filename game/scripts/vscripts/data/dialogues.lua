...
d_untitled_passage_43 = {
text = [[*Огр-громила пал. Он лежит на земле и смотрет в небо. К нему пришло осознание, что это скорее всего последний раз, когда он может насладиться существованием.*]],
speaker = [[Огр-громила]],
npc = "npc_ogre_bruiser",
choices = {
{
...
d_untitled_passage_86 = {
text = [[*Гид восторженно подбегает к тебе.*Алекс! Ты наш спаситель, всё Королевство благодарит тебя за этот великий подвиг!]],
speaker = [[Человек-гид]],
npc = "npc_guide",
choices = {
{
...
d_l12 = {
text = [[2: Никто не поверит в твои бредни, ты тот ещё пень!1: Я вообще не помню, чтоб ты что-то делал. Значит ты этого не делал!]],
speaker = [[Крип-сиамский огр]],
npc = "npc_ogre_magi",
choices = {
{
...
next = "d_p14",
actions = {
{ questID="q_main_quest_2",type="quest_start" },
},
},
},
},
...
d_v_sebe = {
text = [[2: Как можно вообще потеряться в себе, он внутри своей головы живёт?1: Это невозможно. скорее всего он заблудился.]],
speaker = [[Крип-сиамский огр]],
npc = "npc_ogre_magi",
choices = {
{
...
text = [[*1-ая голова начала говорить медленным занудным тоном.*Я Шофёр лимузина. Вожу важных персон. На машине... На конях...]],
speaker = [[Голова умнотуп]],
npc = "npc_ogre_magi",
choices = {
{
...
text = [[*Услышав любимое слово, человек резко повернулся к тебе.*Да! Математика, физика, астрономия и алхимия - всё это есть у нас, молодой человек! Вы новенький тут?]],
speaker = [[Человек-учёный]],
npc = "npc_scientist",
choices = {
{
