...
return {
    ...
    entries = {
        ...
        d_untitled_passage_48_merged_act3 = {
            priority = 60,
            conditions = {
                { interact = "npc_creep_rogach", type = "interact" },
                { ent_var = "first_met_in_act", value = { true }, npc = "npc_creep_rogach", type = "ent_var" },
        ...
        d_untitled_passage_62 = {
            ...
            conditions = {
                ...
                { questID = "q_island_explosion", status = QuestStatus.ACTIVE, step = { 3 },       type = "quest" },
            },
        },
        ...
        d_untitled_passage_merged_act4 = {
            priority = 0,
            conditions = {
                { beat = "npc_derek", type = "beat" },
                { var = "derek_kill", value = { true }, type = "var" },
            },
        },
        d_untitled_passage_1_merged_act4 = {
            priority = 0,
            conditions = {
                { no_item = "item_key",         type = "no_item" },
                { interact = "npc_derek_keyhole", type = "interact" },
            },
        },
        d_untitled_passage_2_merged_act4 = {
            priority = 0,
            conditions = {
                { interact = "npc_derek_keyhole", type = "interact" },
                { has_item = "item_key",        type = "has_item" },
            },
        },
        ...
        d_untitled_passage_69_merged_act4 = {
            priority = 0,
            conditions = {
                { interact = "npc_wasteland", type = "interact" },
        ...
        d_untitled_passage_73_merged_act4 = {
            ...
            conditions = {
                { beat = "npc_derek", type = "beat" },
                { var = "derek_kill", value = { false }, type = "var" },
            },
        },
        d_untitled_passage_74_merged_act4 = {
            priority = 0,
            conditions = {
        ...
        d_untitled_passage_76_merged_act4 = {
            priority = 0,
            conditions = {
                { beat = "npc_george", type = "beat" },
            },
        },
        d_untitled_passage_77_merged_act4 = {
            priority = 0,
            conditions = {
                { interact = "npc_george", type = "interact" },
            },
        },
        d_untitled_passage_78_merged_act4 = {
            priority = 0,
            conditions = {
                { trigger = "trigger_boss_fight_2", npc = "npc_george", type = "trigger" },
        ...
        d_untitled_passage_79_merged_act4 = {
            ...
            conditions = {
                ...
                { var = "made_deal",        value = { false }, type = "var" },
            },
        },
        d_untitled_passage_80_merged_act4 = {
            ...
            conditions = {
                ...
                { interact = "npc_tormentor",   type = "interact" },
                { var = "made_deal",            value = { true },          type = "var" },
            },
        },
        ...
        d_untitled_passage_33_merged_bubbles = {
            priority = 0,
            conditions = {
                { interact = "npc_courier_turtle", type = "interact" },
            },
        },
        d_untitled_passage_34_merged_bubbles = {
            priority = 0,
            conditions = {
        ...
        d_untitled_passage_50_merged_bubbles = {
            priority = 0,
            conditions = {
        ...
        d_untitled_passage_8_merged_bubbles = {
            priority = 0,
            conditions = {
                { interact = "npc_courier_koala", type = "interact" },
            },
        },
        d_untitled_passage_9_merged_bubbles = {
            priority = 0,
            conditions = {
    ...
    nodes = {
        ...
        d_metnut_kamen_v_sooruzhenie = {
            text = [[*Твой бросок на что-то повлиял. Золотая фигура тихо затрещала.*]],
            speaker = [[...]],
            npc = "npc_tormentor",
            choices = {
                {
        ...
        d_nemnogo_otojti = {
            ...
            choices = {
                {
                    text = [[*Это что за гном?!*]],
                    next = "d_eto_chto_za_gnom",
                },
            },
        },
        d_nu_pochemu_ya_to = {
...
*Камышом он указал в сторону леса.*]],
            ...
            choices = {
                {
                    text = [[Ну... Заброшенный лес.]],
                    next = "d_nu_zabroshennyj_les",
                },
            },
        },
        ...
        d_predvestie_uzhe_sbylos = {
            text =
            [[*Горилла замечает тебя. Огромная туша двигается тебе наствречу. Его огромные яйца звенят друг об друга, словно звон утреннего церковного колокола.*]],
            speaker = [[...]],
            npc = "npc_gorilla",
            choices = {
                {
        ...
        d_protyanut_ruku = {
            text = [[*Её глаза засияли. Она была очень довольна.*
Впервые такое вижу. Твоя душа кричит, виднеются десятки различных "сущностей", однако, наподобие сперматозоидам, многие из них погибают, не сумев достигнуть цели. Это твои желания, скрытые за десятками стен эмоций.]],
        ...
        d_razbit_bochku_pinkom = {
            text =
            [[*Бочка разлетелась в дребезги, а содержимое вылилось на твои штаны. Со стороны выглядит так, будто ты обоссался.*
НЕЕЕЕТ, ЧТО ТЫ НАДЕЛАЛ?! ВСЁ ВЫЛИЛОСЬ. Я ТЕБЯ СЕЙЧАС...]],
        ...
        d_snyat_s_nego_mantiu = {
            text = [[*Оттолкнув твою руку, он хватает дубину и с огромной силой ударяет себя по голове.*]],
            speaker = [[Огр-громила]],
            npc = "npc_ogre_bruiser",
            choices = {
                {
...
Ты... Меня впечталил, конечно.]],
        ...
        d_udarit_lbom_emu_po_litsu = {
            text = [[АРГХХ... Ты чё делаешь сука, А?!]],
            speaker = [[Быдло]],
            npc = "npc_monkey_king",
            choices = {
                {
        ...
        d_hm = {
            text = [[*Послышался чей-то едва уловимый крик.*]],
            speaker = [[...]],
            npc = nil,
            choices = {
                {
        ...
        d_schas_by_v_poe = {
            ...
            choices = {
                ...
                {
                    text = [[*Всё-таки начать думать.*]],
                    next = "d_vsetaki_nachat_dumat",
                },
            },
        },
        d_eto_chto_za_gnom = {
        ...
        d_empty = {
            text =
            [[Вообщем, ты их точно не пропустишь, у них очень выразительные цвета: Красный - злобный малый, Зелёный - твердолобый упырь такой, а Синий - непредсказуемый болван.]],
            speaker = [[Пьяная панда]],
            npc = "npc_brewmaster",
            choices = {
                {
                ...
                {
                    text = [[Красный - гневный, Зелёный - упрямый, Синий - непредсказуемый. Запомнил.]],
                    next = "d_a4",
                },
            },
        },
...
*Спросил крип необычайно спокойным голосом.*]],
            speaker = [[Огр-громила]],
            npc = "npc_ogre_bruiser",
            choices = {
                {
        ...
        d_untitled_passage_15 = {
            text =
            [[*Открыв глаза, ты видишь лишь обожённую землю. Золотое сияние неизвестной постройки ослепляет твой взор.*]],
            speaker = [[...]],
            npc = "npc_tormentor",
            choices = {
                {
...
*Окликает тебя крип с рогами. Он выглядит очень расслабленным и довольным.*]],
            speaker = [[Крип-рогач]],
        ...
        d_untitled_passage_19 = {
            text = [[СТОЯЯЯЯЯЯЯТЬ!!
*Всей грудью выкрикнул усатый мужчина спортивного телосложения.*]],
        ...
        d_untitled_passage_23 = {
            text =
            [[*Огромная каменная глыба подзывает тебя. Любое, даже самое небольшое его движение, сотрясает землю под вами обоими.*
Человек. Хочешь разбогатеть?]],
            speaker = [[Синий Принц]],
            npc = "npc_blue_prince",
            choices = {
                {
        ...
        d_untitled_passage_26 = {
            ...
            choices = {
                {
                    text = [[Эм... ты человек или крип?]],
                    next = "d_em_ty_chelovek_ili_krip",
                },
            },
        },
        d_untitled_passage_27 = {
...
*Подзывает тебя, поддёргивая рукой.*]],
        ...
        d_untitled_passage_42 = {
            text =
            [[*Крип причудливой внешности излучает необычайное спокойствие. Его голова туго укутана синей тканью.*]],
            speaker = [[Огр-громила]],
            npc = "npc_ogre_bruiser",
            choices = {
                {
        ...
        d_untitled_passage_43 = {
            text =
            [[*Огр-громила пал. Он лежит на земле и рассматривает небо. К нему пришло осознание, что это, скорее всего, последний раз, когда он может насладиться существованием.*]],
            speaker = [[Огр-громила]],
            npc = "npc_ogre_bruiser",
            choices = {
                {
...
Алекс! Ты наш спаситель, всё Королевство благодарит тебя за этот великий подвиг!]],
        ...
        d_z_eto_camost_a_camost_eto_z = {
            text = [[*Она вышла из боевой стойки.*
Теперь ты член этой Академии. Если расскажешь кому-либо о нашей деятельности, я казню тебя без колебаний.]],
            speaker = [[Хранительница]],
            npc = "npc_templar_assasin",
            choices = {
                {
        ...
        d_z_eto_samost_a_samost_eto_z = {
            text = [[*Существо одобряюще кивнуло.*
Истина.]],
            speaker = [[Крип-загадка]],
            npc = "npc_mystery",
            choices = {
        ...
        d_a2 = {
            text = [[*Существо было удивлено, что после этого ты решил с ним заговорить.*]],
            speaker = [[Пьяная панда]],
            npc = "npc_brewmaster",
            choices = {
                {
        ...
        d_a3 = {
            text =
            [[С тех пор как они стали своевольничать, жизнь пошла по дну. Все знакомые сторонятся меня и обходят. Жена даже из дома выгнала, представляешь?]],
            speaker = [[Пьяная панда]],
            npc = "npc_brewmaster",
            choices = {
                {
                    text = [[Ну... расскажи о сыновьях тогда..]],
                    next = "d_nu_rasskazhi_o_synovyah_togda",
                },
            },
        },
        d_a4 = {
            text =
            [[Я думал люди только и могут, что кричать о величии их Пропавшего Короля. Сидят на жопе и ничего кроме этого не делают. Неужто ты мне поможешь?]],
            speaker = [[Пьяная панда]],
            npc = "npc_brewmaster",
            choices = {
                {
                    text = [[Эй... ты первый крип, что упомянул Короля. Что тебе о нём известно?]],
                    next = "d_ej_ty_pervyj_krip_chto_upomyanul_korolya_chto_tebe_o_nem_izvestno",
                },
            },
        },
        d_flask_barrel = {
            text =
            [[Сверху вниз на тебя взирает пузатая бочка. Если замереть и прислушаться, можно уловить её неспешное, утробное ворчание - мягкое бульканье, которым она зазывает тебя наполнить опустевшую флягу.]],
            speaker = [[Бочка]],
            npc = "npc_flask_barrel",
            choices = {
                {
                    text = [[*Наполнить флягу.*]],
                    next = nil,
                    actions = {
                        { type = "fill_flask" },
                    },
        ...
        d_ghetto_danger = {
            text =
            [[Ты не можешь пошевелиться, тело наотрез отказывается двигаться дальше. В этот раз лучше довериться чутью...]],
            speaker = [[...]],
            npc = nil,
            choices = {
                {
        ...
        d_h = {
            ...
            choices = {
                {
                    text = [[Прояснишь мне, что примерно происходит, не особо втянулся ещё.]],
                    next = "d_proyasnish_mne_chto_primerno_proishodit_ne_osobo_vtyanulsya_esche",
                },
            },
        },
        d_h10 = {
        ...
        d_h5 = {
            text =
            [[На севере - Система подземных путей М.Е.Т.Р.О. (Межрасовая Единая Тоннельно-Рельсовая Объединённая система), ведущих на территории, где поселились "новые" люди.]],
            speaker = [[Гид]],
            npc = "npc_guide",
            choices = {
                {
        ...
        d_h8 = {
            text = [[На юго-западе - Владения двух Каменных Принцев. Они никак не могут поделить свои земли.]],
            speaker = [[Гид]],
            npc = "npc_guide",
            choices = {
                {
            ...
            choices = {
                {
                    ...
                    next = "d_hlup_snap_accent_bass_riff",
                    actions = {
                ...
                },
                {
                    ...
                    next = "d_hlup_snap_accent_bass_cad",
                    actions = {
        ...
        d_hlup_snap_accent_vox = {
            ...
            choices = {
                {
                    text = [[*Сыграть рифф на ширинке с разрешением в тонику.*]],
                    next = "d_hlup_snap_accent_vox_riff",
                    actions = {
                ...
                {
                    text = [[*Отбить ботинками завершающую каденцию.*]],
                    next = "d_hlup_snap_accent_vox_cad",
                    actions = {
        ...
        d_hlup_snap_tempo_bass = {
            ...
            choices = {
                {
                    text = [[*Сыграть рифф на ширинке с разрешением в тонику.*]],
                    next = "d_hlup_snap_tempo_bass_riff",
                    actions = {
                ...
                {
                    text = [[*Отбить ботинками завершающую каденцию.*]],
                    next = "d_hlup_snap_tempo_bass_cad",
                    actions = {
        ...
        d_hlup_snap_tempo_vox = {
            ...
            choices = {
                {
                    text = [[*Сыграть рифф на ширинке с разрешением в тонику.*]],
                    next = "d_hlup_snap_tempo_vox_riff",
                    actions = {
                ...
                {
                    text = [[*Отбить ботинками завершающую каденцию.*]],
                    next = "d_hlup_snap_tempo_vox_cad",
                    actions = {
        ...
        d_hlup_stomp_accent_bass = {
            ...
            choices = {
                {
                    text = [[*Сыграть рифф на ширинке с разрешением в тонику.*]],
                    next = "d_hlup_stomp_accent_bass_riff",
                    actions = {
                ...
                {
                    text = [[*Отбить ботинками завершающую каденцию.*]],
                    next = "d_hlup_stomp_accent_bass_cad",
                    actions = {
        ...
        d_hlup_stomp_accent_vox = {
            ...
            choices = {
                {
                    text = [[*Сыграть рифф на ширинке с разрешением в тонику.*]],
                    next = "d_hlup_stomp_accent_vox_riff",
                    actions = {
                ...
                {
                    text = [[*Отбить ботинками завершающую каденцию.*]],
                    next = "d_hlup_stomp_accent_vox_cad",
                    actions = {
        ...
        d_hlup_stomp_tempo_bass = {
            ...
            choices = {
                {
                    text = [[*Сыграть рифф на ширинке с разрешением в тонику.*]],
                    next = "d_hlup_stomp_tempo_bass_riff",
                    actions = {
                ...
                {
                    text = [[*Отбить ботинками завершающую каденцию.*]],
                    next = "d_hlup_stomp_tempo_bass_cad",
                    actions = {
        ...
        d_hlup_stomp_tempo_vox = {
            ...
            choices = {
                {
                    text = [[*Сыграть рифф на ширинке с разрешением в тонику.*]],
                    next = "d_hlup_stomp_tempo_vox_riff",
                    actions = {
                ...
                {
                    text = [[*Отбить ботинками завершающую каденцию.*]],
                    next = "d_hlup_stomp_tempo_vox_cad",
                    actions = {
...
Я и сам слишком слаб...]],
        ...
        d_i13 = {
            text = [[*Усач громко вздохнул.*
Да... Это самое опасное место в нынешнее время. Напоминает инцидент, когда мы с товарищами пытались остановить аварию на Чернобыльской АЭС... И при жизни, и даже после смерти есть места, где надежда попросту исчезает.]],
            speaker = [[Человек-усач]],
            npc = "npc_mustache",
            choices = {
                {
        ...
        d_i2 = {
            text =
            [[Там обитает Зверь Пустоши, его волосатые ноги меня просто в землю втопчут... Нет ни одного существа, кто ему ровня. Радует, что он не нападает, а только обороняется...]],
            speaker = [[Человек-усач]],
            npc = "npc_mustache",
            choices = {
                {
        ...
        d_i7 = {
            ...
            choices = {
                ...
                {
                    text = [[Тебя зовут Даун.]],
                    next = "d_tebya_zovut_daun",
                },
                {
        ...
        d_i9 = {
            text = [[Отлично. Двери открыты. Сражение нелёгкое. Возможно придётся набраться опыта.]],
            speaker = [[Синий Принц]],
            npc = "npc_blue_prince",
            choices = {
                {
        ...
        d_j10 = {
            text = [[Постарайся уж, а то пока я их не усмирю, жена меня домой не пустит.]],
            speaker = [[Пьяная панда]],
            npc = "npc_brewmaster",
            choices = {
                {
        ...
        d_kk = {
            text =
            [[*Ты слышишь странный звук. Грудь ощущается тяжёлой. Опустив голову вниз, ты замечаешь сквозную дыру. Похоже она попала прям в сердце.*]],
            speaker = [[Хранительница]],
            npc = "npc_templar_assasin",
            choices = {
                {
        ...
        d_l11 = {
            text = [[*Тугая голова повернулась к другой и недовольно бросила взгляд.*
Эй! Вообще-то это я его спас, оттащив брата за дубину, которой он замахивался. Из-за меня дракон промахнулся!]],
            speaker = [[Голова умнотуп]],
            npc = "npc_ogre_magi",
            choices = {
                {
        ...
        d_l12 = {
            text = [[*Дерзкая голова усмехнулась.*
Хех, никто не поверит в твои бредни, ты тот ещё пень!]],
            speaker = [[Голова подначка]],
            npc = "npc_ogre_magi",
            choices = {
                {
...
А колёса твои где? Хихи хи. Неужто уже зима, на лыжи пересел?]],
        ...
        d_l6 = {
            text = [[*От удивления брови тугой головы взлетели до макушки.*
Как по-твоему я поставлю лыжи на коня. Ты вообще не понимаешь чтоли..? У них копыта.]],
            speaker = [[Голова умнотуп]],
            npc = "npc_ogre_magi",
            choices = {
                {
        ...
        d_l7 = {
            text = [[Никак! Сейчас же лето!
*Левая рука почесала левую часть задницы.*
Воооо! Я бы налепил на них ролики!]],
            speaker = [[Голова подначка]],
            npc = "npc_ogre_magi",
            choices = {
                {
            ...
            choices = {
                {
                    ...
                    next = "d_mne_tozhe_odnako_po_drugomu_eto_ne_reshitsya",
                },
            },
        },
        d_m4 = {
            text = [[*Огр слабо хватает твою руку.*
Сорвав её, я умру, ты ведь это понимаешь?]],
        ...
        d_m5 = {
            text =
            [[*Несколько минут ты смотришь на его труп. В мылсях мелькают фразы из вашего диалога. В итоге, ты не решаешься взять мантию.*]],
            speaker = [[Огр-громила]],
            npc = "npc_ogre_bruiser",
            choices = {
                {
...
*Сказано это было спокойно и уверенно, без намёка на гнев. Он ждёт твоих действий.*]],
            speaker = [[Огр-громила]],
            npc = "npc_ogre_bruiser",
            choices = {
                {
        ...
        d_o1 = {
            text = [[*Вдруг в коридоре послышался довольно громкий хлопок. Взрыв? Выстрел?*]],
            speaker = [[...]],
            npc = nil,
            choices = {
                {
        ...
        d_o21 = {
            text = [[*Может быть. Иметь надежду всегда приятно. Будучи недалёким легко быть у неё на поводу.*]],
            speaker = [[...]],
            npc = nil,
            choices = {
                {
        ...
        d_o22 = {
            text =
            [[*Это странно, есть же много способов поднять зелёных. Интересно, что с их умами станет, когда они поймут, что верхушки великих держав подчиняются воле Искрящегося Василиска и вторженцев с Марса?*]],
            speaker = [[...]],
            npc = nil,
            choices = {
                {
        ...
        d_o23 = {
            text =
            [[*Её холодная морщинистая рука обхватила твою горячую ладонь. От перепада температур у тебя пошли муражки. Спустя мгновение, бабка, издав небольшой писк, резко отскочила. У тебя зачесался нос. Почему сейчас то?*]],
            speaker = [[Старушка]],
            npc = "npc_shamanka",
            choices = {
                {
                    text = [[*Зачем я вообще позволил ей это?*]],
        ...
        d_o5 = {
            text =
            [[Как вообще я могу быть счастливым, пока они такие непослушные? Это не жизнь, приходится запивать горе своё. Пока они не воссоединяться и не проявят хоть какое-то уважение, не смогу найти себе места.]],
            speaker = [[Пьяная панда]],
            npc = "npc_brewmaster",
            choices = {
                {
        ...
        d_o7 = {
            text =
            [[А?! Ты ещё здесь? В общем, есть неурядица. Приходили крипочки-хулиганы и начали играть в футбол моим драгоценным шаром! Эти черти разбили его!]],
            speaker = [[Крип Предвестник]],
            npc = "npc_predvestnik",
            choices = {
                {
        ...
        d_p1 = {
            text =
            [[Пока ты был работником сбербанка, я был его директором. Но там было очень легко и скучно, что я решил уволиться и начать заниматься наукой и всего спустя неделю мне выдали Степень Кандидата наук, а потом я изобрёл вечный двигатель, а потом...
*Он без умолку продолжал распинаться о своих достижениях. Твоя попытка - поставить его на место - провалилась.*]],
            speaker = [[Учёный]],
            npc = "npc_scientist",
            choices = {
                {
                    text = [[Ладно ладно, я понял, ты крутой ага... Что там с Равноценным обменом?]],
                    next = "d_p11",
                },
            },
        },
        d_p11 = {
            text =
            [[Ты прав, что-то я забылся! Само понятие Равноценный обмен, по нашим ощущениям, изучено не полностью. Оно несёт что-то очень значимое, а может и смертельно опасное, однако, что именно, мы так всё ещё не поняли... Но из того, что было обнаружено, так это необычное взаимодействие с предметами и материалами.]],
            speaker = [[Учёный]],
            npc = "npc_scientist",
            choices = {
                {
                    text = [[...]],
                    next = "d_scientist_explain_2",
                },
            },
        },
        d_p10 = {
        ...
        d_p3 = {
            text = [[*Он вздохнул указав взгляд на Алхимика. Тот бездумно стоит.*
У моего коллеги хроническая амнезия, представляешь! Приходтся постоянно рассказывать ему курсы всех предметов с 1 по 11 класс, так ещё и план бакалавриата и магистратуры...]],
            speaker = [[Учёный]],
            npc = "npc_scientist",
            choices = {
                {
        ...
        d_p4 = {
            text =
            [[*По какой-то причине свечи начинают сильно разгораться. Тепло, что исходит от них, не греет, а наоборот - обмораживает.*]],
            speaker = [[Крип Предвестник]],
            npc = "npc_predvestnik",
            choices = {
                {
...
*Его яростные взмахи камышом преследовали тебя, пока ты отдалялся. Тебя это улыбнуло.*]],
        ...
        d_v_printsipe_ya_ponyal_vy_dva_daunicha = {
            text = [[*Тугая голова была шокирована твоей несправедливой оценке.*
НЕТ! Мы довольно смышлённые, даже думать умеем! А вдвоём наш разум увеличивается в три раза!]],
            speaker = [[Голова умнотуп]],
            npc = "npc_ogre_magi",
            choices = {
                {
...
1: Это невозможно. скорее всего он заблудился.]],
        ...
        d_vash_brat_tak_skazal = {
            text = [[О, ты нашёл его? Он всё ещё ходит с той огромной дубиной, да?]],
            speaker = [[Голова умнотуп]],
            npc = "npc_ogre_magi",
            choices = {
                {
        ...
        d_vsego = {
            text = [[*Он несколько раз кивнул головой, огромные струи пара выходили из его носа.*
Великая мудрость... Что ж, свидимся позже.]],
            speaker = [[Красный]],
            npc = "npc_red",
            choices = {
                {
...
Не думал, что в мире остались люди с яйцами!]],
        ...
        d_da_bolshaya_yama = {
            ...
            choices = {
                {
                    text = [[Хм... а где сам метеорит?]],
                    next = "d_hm_a_gde_sam_meteorit",
                },
            },
        },
        ...
        d_da_i_ya_obozhau_reshat = {
            text = [[Ого! Наконец-то смышлённый человек забрёл в этот мир. Чудеса!]],
            speaker = [[Учёный]],
            npc = "npc_scientist",
            choices = {
                {
                    text = [[Ты вроде упомянул алхимию. Разве она существует?]],
                    next = "d_ty_vrode_upomyanul_alhimiu_razve_ona_suschestvuet",
                },
            },
        },
        d_davajte_sami = {
...
Дубина, там сокровища, слышишь??]],
        ...
        d_dumau_net = {
            text = [[Тогда возвращайся в безопасноcть, в этом лесу куча кровожадных существ, тебе здесь не место.]],
            speaker = [[Огр-громила]],
            npc = "npc_ogre_bruiser",
            choices = {
                {
        ...
        d_dumau_on_prav = {
            text = [[*Обе головы хором отвечают.*
У нас два мозга, а у тебя один. Не сравнивай нас с собой!]],
        ...
        d_esli_by_ya_vstretil_vas_pri_zhizni_to_mozhet_postupil_by_v_kempridzh = {
            text =
            [[Будь благодарен тому, что сможешь обучаться этому сейчас! Присоединяйся как-нибудь к нам и станешь умнейшим в этих краях, так и сможешь исследовать эту загадочную вселенную!]],
            speaker = [[Учёный]],
            npc = "npc_scientist",
            choices = {
                {
                    text = [[Не знаю, сейчас дела есть. Кстати, а дадите мне один Философский камень?]],
                    next = "d_ne_znau_sejchas_dela_est_kstati_a_dadite_mne_odin_filosofskij_kamen",
                },
            },
        },
        d_zhmot = {
            text = [[*После таких слов, он разозлился, поставил бочку на землю и пнул её в тебя, что-то выкрикнув.*]],
            speaker = [[Пьяная панда]],
            npc = "npc_brewmaster",
            choices = {
                {
        ...
        d_znaesh_ya_peredumal = {
            text =
            [[*Красный с энтузиазмом глазеет в твою сторону. Его губы начинают дрожать, новое оскорбление вот вот вылетит из них со свистом. Однако ты делаешь ход раньше.*]],
            speaker = [[Красный]],
            npc = "npc_red",
            choices = {
                {
        ...
        d_i_tebe_horoshego = {
            text = [[*Рогач стучит себя по груди и машет тебе, пока ты уходишь.*]],
            speaker = [[Крип-рогач]],
            npc = "npc_creep_rogach",
            choices = {
                {
...
Нет. Я просто не хочу быть прежним. Сейчас я владею всеми знаниями мира, это высшее наслаждение.]],
        ...
        d_menya_prislal_tvoj_brat_ili_tochnee_bratya = {
            text = [[Понимаю.]],
            speaker = [[Огр-громила]],
            npc = "npc_ogre_bruiser",
            choices = {
                {
                    ...
                    next = "d_oni_bespokoyatsya_za_tebya_verneshsya_k_nim",
                },
            },
        },
        d_mne_kazhetsya_ya_znau_parol = {
            ...
            choices = {
                {
                    text = [[Самость - это Z, а Z - это Самость.]],
                    next = "d_kk",
                },
                {
                ...
                {
                    text = [[Z - это Z, Самость - это Самость.]],
                    next = "d_kk",
                },
                {
                    text = [[Z Z Z ZZZZZZZZZ]],
                    next = "d_kk",
                },
            },
        },
...
*Огромная тяжёлая дубина крепко сидит в руке огра. Похоже он наделён не только огроными знаниями.*]],
        ...
        d_ne_znau_sejchas_dela_est_kstati_a_dadite_mne_odin_filosofskij_kamen = {
            text = [[Конечно! Только не показывай простолюдинам. Используй в тайне!
*Учёный достал круглый сверкающий камушек из кармана и протянул тебе.*]],
            speaker = [[Учёный]],
            npc = "npc_scientist",
            choices = {
                {
        ...
        d_ne_ne_mne_ne_vazhno_kto_vy_ya_sprashival_chto_za_rasa_u_vas = {
            text = [[*Его физиономия на мгновение застыла. Он был поражён твоей наглости.*
Разорвём на части эту тварь!! Рвите его!!!]],
            speaker = [[Банда троллей]],
            npc = "npc_gate_troll_uruk",
            choices = {
                {
...
*Крип начал палкой двигать осколки.*]],
        ...
        d_no = {
            ...
            choices = {
                {
                    text = [[Ну да, бывает такое.]],
                    next = "d_nu_da_byvaet_takoe",
                },
            },
        },
        d_nu_da_byvaet_takoe = {
        ...
        d_nu_kak = {
            text =
            [[Знаешь... лучше. Твои удары усмирили мой гнев. Что-то я уж больно вспылил, даже неприятно вспоминать кем я был минуту назад.
*Красный неловко чешет затылок.*
Благодарю за возвращение в спокойное состояние.]],
            speaker = [[Красный]],
            npc = "npc_red",
            choices = {
                {
        ...
        d_nu_rasskazhi_o_synovyah_togda = {
            text =
            [[Ооох, они прекрасные, но в последнее время на них что-то нашло, перестали подчиняться приказам старика. Бывало, даже заставляли меня делать ужасные вещи: воровать, буянить, даже нападать на окружающих... Ох, ужас...]],
            speaker = [[Пьяная панда]],
            npc = "npc_brewmaster",
            choices = {
                {
...
*Упёрто ответил он.*]],
        ...
        d_prosto_tak_do_takoj_stepeni_ne_napivautsya_chto_ne_tak_puzan = {
            text =
            [[*Помотав глаза из стороны в сторону, он завыл и всё-таки решился поделиться с тобой своей трагедией.*
Да беда ужасная настигла... У меня есть три сына, понимаешь, а они сбежали от папки своего, не хотят ладить со мной.]],
        ...
        d_proyasnish_mne_chto_primerno_proishodit_ne_osobo_vtyanulsya_esche = {
...
Ты умер будучи человеком.]],
            ...
            choices = {
                {
                    text = [[Эм... это ад? Или рай?]],
                    next = "d_h2",
                },
                {
                    text = [[Эм... я реинкарнировал?]],
                    next = "d_h2",
                },
                {
                    text = [[Эм... мы в лимбе?]],
                    next = "d_em_my_v_limbe",
                },
            },
        },
        d_rad = {
...
*Приветливо сказала хранительница.*]],
            speaker = [[Хранительница]],
            npc = "npc_templar_assasin",
            choices = {
                {
...
*От радости, его хвост начал вилять из стороны в сторону, обдавая твоё лицо прохладным воздухом. После он вновь замер, пытаясь вспомнить своё имя.*]],
            speaker = [[Боб]],
            npc = "npc_creep_bob",
            choices = {
                {
        ...
        d_tebya_ischet_otets_vozvraschajsya_domoj = {
            ...
            choices = {
                {
                    text = [[Ты знаешь о ком я говорю. Братья тоже ждут.]],
                    next = "d_ty_znaesh_o_kom_ya_govoru_bratya_tozhe_zhdut",
                },
            },
        },
...
Верно, но я поддался искушению. Поверь, моим братьям Мантия будет только во вред.]],
        ...
        d_ty_vrode_upomyanul_alhimiu_razve_ona_suschestvuet = {
            text = [[*Он был настолько рад твоей любознательности, что его культяпки аж непроизвольно завертелись.*
Отличный вопрос! Вообще нет, однако в этом мире правила другие. Сначала я испугался смерти в реальном мире, однако, увидев что происходит тут, просто расцвёл! Куча загадок требует ответов.]],
            speaker = [[Учёный]],
            npc = "npc_scientist",
            choices = {
                {
        ...
        d_ty_zh_govoril_chto_ona_pustaya = {
            ...
            choices = {
                {
                    text = [[Просто так до такой степени не напиваются. Что не так, пузан?]],
                    next = "d_prosto_tak_do_takoj_stepeni_ne_napivautsya_chto_ne_tak_puzan",
                },
            },
        },
...
Да. Упёртость - есть удел недалёких. Я понимал, что без драки не обойдётся.]],
        ...
        d_ty_znaesh_o_kom_ya_govoru_bratya_tozhe_zhdut = {
        ...
        d_ty_sluchajno_ne_ogrgromila = {
            text = [[Да, это я.
*Уверенно произнёс огр.*]],
            speaker = [[Огр-громила]],
            npc = "npc_ogre_bruiser",
            choices = {
                {
                    text = [[Меня прислал твой брат... Или точнее братья.]],
                    next = "d_menya_prislal_tvoj_brat_ili_tochnee_bratya",
                },
            },
        },
...
И вправду... Где он?]],
        ...
        d_hm__2 = {
            text = [[*Вдруг ты услышал голос внутри себя. Ты начал непроизвольно повторять одну и ту же фразу.*]],
            speaker = [[Крип-загадка]],
            npc = "npc_mystery",
            choices = {
                {
...
Король... Его зовут Джордж. Джордж Богоподобный. Он лучший человек... Идеальный во всём.]],
        ...
        d_chto_znachit_v_odin_moment_kak_eto_voobsche_proishodit = {
            text = [[*Алхимик что-то прошептал учёному.*
Ох, точно! Я же не объяснил как направлять эту силу. Видишь около себя разноцветную консистенцию? После затвердевания из неё получются Философские камни, которые как раз и делают все преобразования в считанные секунды!]],
        ...
        d_chtoto_ne_tak = {
            text =
            [[Скрытая Академия хранит много тайн. Я дала обет, что буду защищать их от чужих глаз. Уходи, если дорога жизнь.]],
            speaker = [[Хранительница]],
            npc = "npc_templar_assasin",
            choices = {
                {
        ...
        d_chto = {
            text = [[*Свет в его глазах угасает. Постепенно тело становится бездыханной оболочкой.*]],
            speaker = [[Огр-громила]],
            npc = "npc_ogre_bruiser",
            choices = {
                {
        ...
        d_chto__1 = {
            text =
            [[Я дам тебе новый смысл жизни. Так во внемли словам моим! Теперь у тебя есть миссия, Королевству нужен заступник.]],
            speaker = [[Старушка]],
            npc = "npc_shamanka",
            choices = {
                {
        ...
        d_che_ty_krichish = {
            text = [[*Гантеля взлетает вверх, словно пёрышко, будто он даже не прикладывает усилий.*
Вижу по твоим глазам, ты как я!
Хочешь испытаний, хочешь проверить себя!]],
            speaker = [[Человек-усач]],
            npc = "npc_mustache",
            choices = {
                {
        ...
        d_che = {
            ...
            choices = {
                {
                    text = [[Эм... А откуда ты это сказал?]],
                    next = "d_em_a_otkuda_ty_eto_skazal",
                },
            },
        },
        d_ej_ty_pervyj_krip_chto_upomyanul_korolya_chto_tebe_o_nem_izvestno = {
            text = [[*Он надолго призадумался.*
Ааа... О нём мало знаю. Мне кажется когда-то я его даже видел... Или нет?.. Вроде кто-то напал на него. Но когда?]],
            ...
            choices = {
                ...
                {
                    text = [[Ага. Удачи тебе в поисках тогда.]],
                    next = "d_j11",
                    actions = {
        ...
        d_eto_zachem = {
            text =
            [[Я способна пробуждать скрытые возможности тела человека. Коснись меня и твоя истинная форма проявится. Быстрее!]],
            speaker = [[Старушка]],
            npc = "npc_shamanka",
            choices = {
                {
        ...
        d_eto_kak = {
            text = [[*Учёный несколько раз цокнул языком, думая как ответить.*
Вообще, это невероятно сложный концепт, который просто так не объяснить. Для понимания нужно около 240 IQ, а у тебя, к сожалению, на данный момент, около 100...]],
            speaker = [[Учёный]],
            npc = "npc_scientist",
            choices = {
                {
                    text = [[Может и так, но раз уж ты такой умный, то должен уметь объяснять сложные вещи по простому.]],
                    next = "d_p11",
                },
                {
                    text = [[Вообще-то я в сбербанке работал, туда только умнейших и ебейших берут.]],
                    next = "d_p1",
                },
            },
        },
        ...
        d_eh = {
            text = [[*Только сейчас они вспомнили про тебя.*
Смотри! Этот паренёк вообще как спичка! Давай проведём им по шершавому!]],
            speaker = [[Голова подначка]],
            npc = "npc_ogre_magi",
            choices = {
                {
        ...
        d_eej_alo = {
            text = [[*Крип отпрыгнул. После начал медленно приближаться, выпячивая зубы вперёд.*
Мммм... Человеческое дитя, видать, тебя послали из Королевства помочь мне?]],
        ...
        d_ya_aleks_voobscheto = {
            text = [[Разве? Извиняй, перепутал немного. Некрасиво получилось, да...]],
            speaker = [[Крип-рогач]],
            npc = "npc_creep_rogach",
            choices = {
                {
...
Что?! Н.. но зачем. Это же порча священного имущества. Тебя могут покарать те, кто сверху!]],
            ...
            choices = {
                {
                    text = [[Типо прикольно, я будто месси роналду. А чем шар ценен то?]],
                    next = "d_o8",
                },
            },
        },
        ...
        d_ya_koroche_poshel = {
            text = [[Стой! Мы просим твою помощь...
*Он замолок, нагоняя ужаса и пытаясь показать всю серьёзность их беды.*
Брат наш, Огр-громила, ПОТЕРЯЛСЯ!]],
            speaker = [[Голова умнотуп]],
            npc = "npc_ogre_magi",
            choices = {
                {
        ...
        d_ya_togda_tozhe_budu = {
            text = [[МОЛОДЧИНА!
*Далее он рассказывал о своих подвигах при жизни, но все его речи пролетали мимо твоих ушей. Твой взгляд был устремлён на гантелю. Красивая гантеля.*]],
            speaker = [[Человек-усач]],
            npc = "npc_mustache",
            choices = {
                {
...
Это отличная новость! Мы не могли обеспечить защиту этих врат, так как нас, людей, осталось единицы... Но ты смог одолеть врага в одиночку!]],
        ...
        d_vzyat_nagradu = {
            text = [[Ещё раз благодарю за выполненную работу.
*Он слегка поклонился.*
Тогда твоим следующим заданием будет сборка всех пропавших частей ключа. После, возвращайся ко мне, и всё обдумаем.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_otdat_bilet = {
            ...
            choices = {
                {
                    text = [[*Кто же там может выступать?..* ]],
                    next = nil,
                    actions = {
...
Невероятно!]],
        ...
        d_poteret_emu_nosik = {
            text =
            [[*Подойдя поближе, ты замечаешь, что его нос сверкает, словно золотой слиток. Похоже подобное желание приходило в голову многим. Ты начинаешь смачно тереть его нос, прям втирать. Он всё ещё неподвижно наблюдает, но, опустив брови, его взгляд становится более сердитым.*]],
            speaker = [[Зелёный]],
            npc = "npc_green",
            choices = {
                {
        ...
        d_pohozhe_gdeto_v_skrytoj_akademii = {
...
Даже тогда, когда я был уверен в правоте оппонента, я старался убедить себя в обратном и шёл на дешёвые приёмы: угрозы, запугивания и даже избиения.]],
        ...
        d_tebya_probivaet_na_slezu_ot_voshischeniya = {
            text =
            [[Вот только мне неоткуда черпать инфу, как таким стать. В Королевстве никто не знает о тонкостях их жизни.
*Хотя на его лице вечная улыбка, тебе отчётливо видны все те душевные муки, что сокрыты глубоко в нём.*]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
        ...
        d_3_monety = {
            text = [[*Его кулаки сжаты до предела.*
5 монет!]],
            speaker = [[Перекуп]],
            npc = "npc_perekup",
            choices = {
        ...
        d_7_monet_po_420_eto_2940_a_bilety_stoyat_50_ne_shoditsya = {
            text = [[Так... Так.....
*Перекуп был шокирован от твоей наглости.*
Так я шёл тебе на компромиссы! Изначальная цена была гораздо больше!]],
            speaker = [[Перекуп]],
            npc = "npc_perekup",
            choices = {
                {
        ...
        d_b = {
            text =
            [[*Импульс невероятной силы прилетел в твою сторону. Ты потерял равновесие и упал, задохнувшись. Существо же сказало только одно слово.*
Неуважение.]],
            speaker = [[Зелёный]],
            npc = "npc_green",
            choices = {
        ...
        d_d5 = {
            text = [[*Привстав, Зелёный крепко жмёт твою руку*
...
*Откуда-то послышался чей-то писклявый голос. Осмотевшись, ты никого не замечаешь, однако, потянувшись почесать ногу, перед тобой предстаёт мелкий крип. У него огромная челюсть, по ощущениям, туда бы поместился арбуз.*]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
...
*Тебя окликает неизвестное существо.*]],
        ...
        d_fairytale = {
            text = [[Дитя, послушай мой рассказ.
*Глубоким голосом подзывает медитирующий мужчина.*]],
            speaker = [[Сказитель]],
            npc = "npc_storyteller",
            choices = {
                {
...
*Ехидно произнёс крип.*]],
        ...
        d_green_win = {
            text = [[*Ударная волна снесла стойку Зелёного, после чего тот начал терять баланс.*
Невероятная... сила...]],
            speaker = [[Зелёный]],
            npc = "npc_green",
            choices = {
                {
                    text = [[Внешка не важна, понимаешь? Сила внутри, вот здесь.]],
                    next = "d_vneshka_ne_vazhna_ponimaesh_sila_vnutri_vot_zdes",
                },
            },
        },
        d_guide_act_2 = {
        ...
        d_hermit_again = {
            text =
            [[Первую часть я отдал старушке-медиуму, вторую - спрятал на соседней Снежной горе, а третью - скормил самому могучему крипу Искажённого леса.]],
            speaker = [[Отшельник]],
            npc = "npc_hermit",
            choices = {
                {
        ...
        d_hermit_first_met = {
            text =
            [[*Одинокий человек угрюмо смотрит на сверкающий от солнца снег. Здесь почему-то  холоднее обычного.*]],
            speaker = [[Отшельник]],
            npc = "npc_hermit",
            choices = {
                {
                    ...
                    actions = {
                        { music = "music.silence.explore", type = "music_start" },
                    },
                },
            },
        },
        d_hermit_i_get_it = {
            text =
            [[Эти места были выбраны не просто так. Только человек с крепким телом и духом сможет заполучить их все. Только сильнейшему дозволено распоряжаться тем, как использовать этот ключ.]],
            speaker = [[Отшельник]],
            npc = "npc_hermit",
            choices = {
                {
                    text = [[Я готов.]],
                    next = "d_hermit_im_ready",
                },
            },
        },
        d_hermit_im_ready = {
...
Ну... ладно...]],
        ...
        d_k10 = {
            text = [[Он был очень... ленивым.
*Сказитель сделал большой акцент на последнем слове.*
Узнав о том, что Нефелим может исполнить любое желание, ему пришла в голову интересная идея.]],
            speaker = [[Сказитель]],
            npc = "npc_storyteller",
            choices = {
                {
        ...
        d_k21 = {
            text =
            [[Кролик быстро осознал, насколько ужасно это место. Он не мог вынести мысли, что кто-то тоже может оказаться в этой ловушке.]],
            speaker = [[Сказитель]],
            npc = "npc_storyteller",
            choices = {
                {
...
*Сказитель взял паузу.*]],
        ...
        d_k4 = {
            text = [["А ты же выпустишь меня обратно?", - испуганно спросил кролик?
Нефилим покачал головой, добавив: "Теперь это - твой дом."]],
        ...
        d_l1 = {
            text =
            [[*Он пыхтит как паровоз. От невероятной концентрации на вашей дуэли его язык аж вывалился. Вот вот он потеряет сознание.*
1 монета!!!!!]],
            speaker = [[Перекуп]],
            npc = "npc_perekup",
            choices = {
...
Спасибо, спасибо!! Ты реально оу джи, кекс! Ты лучший!!]],
            ...
            choices = {
                {
                    text = [[Хорошо, хорошо. Я кстати тоже туда пойду.]],
                    next = "d_horosho_horosho_ya_kstati_tozhe_tuda_pojdu",
                },
            },
        },
        d_leader_again_1 = {
            text =
            [[Чтобы открыть проход в Коралловый лес, подойди поближе к двери и произнеси заклинание вслух: "Stringus Collapsus".]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_leader_first_met = {
            text = [[*Опрятная комната. Около резного стола стоит мужчина, скорее всего, высокого статуса..*
Здравствуй, Алекс.
*Сказал он с дружелюбным тоном, не поднимая глаз со страниц старинной книги. Дочитав строчку, он захлопнул книгу.*]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_mystery_interact_2 = {
            ...
            choices = {
                {
                    text = [[Спасибо за проходку, конечно, но о чём был наш прошлый разговор?]],
                    next = "d_spasibo_za_prohodku_konechno_no_o_chem_byl_nash_proshlyj_razgovor",
                },
            },
        },
        d_q = {
            text =
            [[Пока он был правителем, жизнь была невероятной! Крипы и люди постоянно развивались и достигали новых высот где только можно: медицина, наука, сельское хозяйство, архитектура... Это была словно утопия.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_q1 = {
            text = [[Однако на смену солнцу всегда приходит луна.
*Он сглотнул.*
Однажды явился Зверь и безжалостно расстерзал нашего прекрасного Короля...
*У Главы пошла слеза.*]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
        ...
        d_q10 = {
            text =
            [[*Не открывая глаз, он начал демонстрировать интонацию и движения, которые он совершал при разговоре с Дереком.*
...
После нашего разговора, я не решился возвращаться в Королевство в одиночку.]],
            speaker = [[Отшельник]],
            npc = "npc_hermit",
            choices = {
                {
                    text = [[Почему он пощадил именно тебя?]],
                    next = "d_pochemu_on_poschadil_imenno_tebya",
                },
            },
        },
        d_q14 = {
...
*Шёпотом прокричал он.*]],
        ...
        d_q17 = {
            ...
            choices = {
                {
                    text = [[Ну пожалуйста, наверное...]],
                    next = "d_nu_pozhalujsta_navernoe",
                },
            },
        },
        d_q18 = {
            text =
            [[Только вот я не просто его выбросил... Перед этим, мной было принято решение разломать ключ на три части...]],
            speaker = [[Отшельник]],
            npc = "npc_hermit",
            choices = {
                {
        ...
        d_q2 = {
            text =
            [[Невероятный гнев охватил всех людей, и, собравшись гиганстким войском, они загнали Зверя в Пустошь, дав ему там бой. Но никто не знал...]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
И что?]],
        ...
        d_q5 = {
            text =
            [[Прекращай этот фарс и, наконец, продемонстрируй развитость своего ума. Я позволю тебе решить задачку, к которой сам всё ещё не смог подступиться. Посмотрим, чего ты стоишь.]],
            speaker = [[Крип-гений]],
            npc = "npc_genius",
            choices = {
                {
...
Зачем я пошёл на поводу у крестьянина и потратил столько драгоценного времени...]],
        ...
        d_q7 = {
            text =
            [[*Крип замер. По его глазам видно, как он перебирает кучу вариантов и пытается найти просчёт в твоих исчислениях.*
Ты...]],
            speaker = [[Крип-гений]],
            npc = "npc_genius",
            choices = {
        ...
        d_q8 = {
            text =
            [[Израненный Дерек, словно демон, выискивал нас по одному и цеплялся когтями, пока сердце жертвы не переставало стучать... С каждым ранением он становился жестчё и беспощаднее. Даже толпой у нас не было шансов...]],
            speaker = [[Отшельник]],
            npc = "npc_hermit",
            choices = {
                {
...
Мои пятки были в крови и я просто застыл, однако Дерек не спешил нападать. Он... он просто остановился, начав глубоко дышать... Вдох... Выдох... Вдох.]],
        ...
        d_r = {
            text =
            [[Отличная работа. Было бы ужасно, если бы выяснилось, что путь до Дерека закрыт на ключ, ты бы проделал сложный путь в пустую.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_r1 = {
            text =
            [[Мы с тобой - два человека, которые жили и умерли на Земле, но по какой-то причине нам позволили остаться здесь.
*Глава активно жестикулирует, подчёркивая серьёзность своих слов.*
Так почему бы не сделать этот мир лучшим местом и не насладиться последними мгновениями жизни, что нам даровали?]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_r2 = {
            text = [[*Слова из его уст были твёрдыми и чёткими.*
Если бы ты знал, что это насекомое - человек, то смог бы так просто убить его?]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_r3 = {
            text =
            [[Ступай же и соверши предначертанное. Пусть тяжесть его греха обернется невыносимым бременем расплаты.]],
            speaker = [[Старушка]],
            npc = "npc_shamanka",
            choices = {
                {
            ...
            choices = {
                {
                    ...
                    actions = {
                        { var = "perekup_negotiated", value = true, type = "set_var" },
                    },
                },
            },
        },
        ...
        d_seller_no_quest = {
            ...
            speaker = [[Представительный человек]],
            npc = "npc_perekup",
            choices = {
                {
        ...
        d_where_is_leader = {
            ...
            choices = {
                {
                    text = [[*Похоже где-то в Скрытой Академии.*]],
                    next = "d_pohozhe_gdeto_v_skrytoj_akademii",
                },
            },
        },
        d_xavier_after_fight = {
...
That was dope, you're feeling me, yeah]],
        ...
        d_xavier_yes = {
            text =
            [[You proved yourself for real like, um... like youre my hood-bro now. I'm glad that... that I can continue my work here, yeah.]],
            speaker = [[xaviersobased]],
            npc = "npc_xavier",
            choices = {
                {
...
Я не знаю...]],
        ...
        d_a_zachem_tebe = {
            text =
            [[Тут неподалёку есть гетто, но там все живут по понятиям, а я ничего не знаю... Даже говорить с ними боюсь, ведь у них свой диалект какой-то...]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
                    text = [[Прийти неподготовленным в гетто опасно так-то.]],
                    next = "d_prijti_nepodgotovlennym_v_getto_opasno_takto",
                },
            },
        },
        d_a_kak_ty_perezhil_s_nim_vstrechu = {
            text =
            [[Я? Когда она ворвалась в Королевство, так я сразу с ноги в неё влетел, после чего мы сцепились. Была жёсткая битва! Однако поняв, что я ей не ровня, та просто сбежала в сторону леса.]],
            speaker = [[Человек-усач]],
            npc = "npc_mustache",
            choices = {
                {
...
Слышь, щегол. Я главный фанат Ксавьера, уяснил?!]],
        ...
        d_aga_tak_kto_takoj_derek = {
            text = [[*Глава начинает загибать пальцы.*
Предатель, изменник, грешник и просто самый мерзкий человек...]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
                    text = [[Зачем он убил Короля?]],
                    next = "d_zachem_on_ubil_korolya",
                },
            },
        },
        d_bilety_na_kontsert_eto_zhe_ty_ih_prodaesh = {
            text = [[Да-с. По самым низким ценам, и, конечно, самые лучшие. В первый ряд!
*Тебя смутила его последняя фраза. Что значит "В первый ряд" на концерте?*]],
            speaker = [[Перекуп]],
            npc = "npc_perekup",
            choices = {
                {
        ...
        d_budu_hranit_etot_dar_vechno = {
            text =
            [[*He smiles and throw some signs with his hands. Xavier picks up microphone and continues performing. Flow's back on track.*]],
            speaker = [[xaviersobased]],
            npc = "npc_xavier",
            choices = {
                {
        ...
        d_bylo_delo = {
            text =
            [[Я всем рассказал про тебя, так что не удивляйся, если незнакомцы будут обращаться по имени. Ты наш герой бро.]],
            speaker = [[Крип-рогач]],
            npc = "npc_creep_rogach",
            choices = {
                {
        ...
        d_v_kakom_plane = {
            text =
            [[Ты в одиночку одолел монстра-гориллу! Тут так-то моя заслуга, ведь после встречи с такими кулаками и усами, эта горилла сильно ослабла.
*Потягивает ус.*]],
            speaker = [[Человек-усач]],
            npc = "npc_mustache",
            choices = {
...
Знаешь... Ты открыл мне глаза. Всё время я смотрел на остальных сверху вниз, но почему? Даже не пытался выслушать их. Может ли быть такое, что... я просто надменный?]],
        ...
        d_vy_hotite_menya_zaverbovat_ili_kak = {
            text = [[Верно, но я не буду тебя заставлять. Хочу лишь, чтобы ты оглянулся и задумался...]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
Хм... Хорошо. Возможно, ты и есть тот, кто должен был оказаться на моём месте.]],
        ...
        d_dopustim_a_zachem_pozval_menya_to = {
            text =
            [[Ты меня поразил, Алекс. Ты не только начал помогать горожанам, так и спас всех от участи, которая будет пострашней гибели. Благодарю от имени всего Королевства.
...
Я уверен, что это не так.]],
        ...
        d_esli_hochesh_ubeditsya_to_provedi_rukoj_po_golove = {
            text =
            [[*Он не предпринимает никаких действий, но ты замечаешь, как от напряжения, его тело начинает немного увеличиваться в размерах.*]],
            speaker = [[Зелёный]],
            npc = "npc_green",
            choices = {
                {
        ...
        d_zdes_delo_ne_v_tom_kto_silnee_ili_slabee_prosto_u_tebya_na_golove_nasrano = {
            ...
            choices = {
                {
                    text = [[Ты туповат, так что забей.]],
                    next = "d_ty_tupovat_tak_chto_zabej",
                },
            },
        },
        d_i_vpravdu = {
        ...
        d_i_znaesh_li_moj_kulak_drobit_kamni_a_tut_peredo_mnoj_glyba_tak_chto_poslednij_shans_pojti_so_mnoj = {
            text =
...
*Пальцем он указал на землю.*]],
        ...
        d_i_ty_poluchaetsya_pervyj_kto_podhvatilsya_da = {
            text = [[Взял инициативу.
*Парировал он.*
Но ты не подумай, у меня великие цели. Каждый день я тружусь во благо Королевства, поэтому приходится управлять всем из безопасности, ведь, если со мной что-то случится, то всё рухнет.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
*Он оцепенел.*]],
        ...
        d_kak_ty_postupil = {
            text =
            [[Наихудшим образом. Я, можно сказать, снял с себя ответственность, выкинув ключ. Теперь это не моя забота...]],
            speaker = [[Отшельник]],
            npc = "npc_hermit",
            choices = {
                {
                    text = [[А где он ща?]],
                    next = "d_a_gde_on_scha",
                },
            },
        },
        d_kak_eto = {
        ...
        d_kakaya_moya_tsel_sejchas = {
            text =
            [[Найди отшельника в Снежных горах и узнай, что тот видел в роковую ночь. Может быть ему известна слабость Зверя.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_kakih_drugih = {
            text =
            [[Части разных лесов соедины между собой вратами, которые я закрыл на печати, дабы опасные существа не пробирались в Королевство.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_konechno_moj_goat = {
            text =
            [[Shout out to all my fans here, that's the gang, that's the gang, um, especially you, Alex. Take this small shi, its a gift from me to you bro.]],
            speaker = [[xaviersobased]],
            npc = "npc_xavier",
            choices = {
                {
...
x * (x^2 + 1)^3]],
        ...
        d_ladno_a_kakaya_vneshnost_u_perekupa = {
            text = [[Синий плащ... и... большая борода, да!]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
        ...
        d_mne_bez_raznitsy_kakto = {
            text = [[*Он на мгновение задумался.*
Слышал, что ты любишь решать, верно? Представь, что завтра нас всех не станет. Больше никаких примеров... Больше никаких задачек... И даже оценки не от кого не получить...]],
            ...
            choices = {
                {
                    text = [[Н..Нет! Не позволю такому случится! Я... я буду бороться!]],
                    next = "d_ya_gotov_pomoch",
                },
            },
        },
        ...
        d_mne_pohuuj = {
            text =
            [[Твоя низкая самооценка сподвигает использовать такой примитивный инструмент. Он мне уже наскучил, покажи что-нибудь другое.]],
            speaker = [[Крип-гений]],
            npc = "npc_genius",
            choices = {
                {
...
*Настороженно спросил перекуп.*]],
        ...
        d_nagrada_budet = {
            text =
            [[Конечно. И кстати, мне сообщили, что ты устранил опасных крипов на территории Заброшенного леса. Предлагаю продолжить это и в других лесах.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
*Какое-то время он поясняет, насколько эта история важна для их культуры, однако ты всё прослушал, забывшись в своих мыслях. Изображение гориллы въелось в твоё сознание и никак не хотело исчезать.*]],
            speaker = [[Сказитель]],
            npc = "npc_storyteller",
            choices = {
                {
        ...
        d_nu_ladno = {
            text = [[*Ты собрался уходить, как он тебя окликнул.*
А ещё, дверь, ведущая к монстру, что поглотил часть ключа, находится в Искажённом лесу. Самом страшном месте... после Пустоши конечно. Держи заклинание от врат в этот лес: "Logarithmus solvus".]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
Тебе наверное интересно, что стало с ключом?]],
        ...
        d_nu_sajt_gde_bilety_onlajn_pokupaut = {
            text = [[Обманывать меня решил?! В этом мире нету интернета, паренёк!
*От злости он начал скрежетать зубами.*
Я передумал. Для тебя билет - 1000 золота, вот!]],
            speaker = [[Перекуп]],
            npc = "npc_perekup",
            choices = {
                {
        ...
        d_nu_tipo_da = {
            text =
            [[Мне сообщили, что ты прибыл недавно, так что есть вещи, которые ты должен знать. Расклад сейчас такой: людей осталось мало, а враждебные крипы постоянно совершают убийства и грабежи. Мы не можем давать отпор.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
                    text = [[Вы хотите меня завербовать или как.]],
                    next = "d_vy_hotite_menya_zaverbovat_ili_kak",
                },
            },
        },
        d_oj_ya_pereputal_u_menya_ne_zoloto_a_tenge = {
            text = [[Тенге...
*Пальцем он начал писать воображаемые цифры.*
Получается по курсу это где-то... СЕМЬ ЗОЛОТА??!?!]],
            speaker = [[Перекуп]],
            npc = "npc_perekup",
            choices = {
                {
        ...
        d_pokupau = {
            text = [[ПРОДАНО!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
*С лица перекупа стекает пот, он еле дышит, ощущение, что он сейчас задохнётся.*]],
            speaker = [[Перекуп]],
            npc = "npc_perekup",
            choices = {
                {
        ...
        d_perekupy_vy_suki = {
            text = [[*Чувствуя твою агрессию, перекуп потянул руку в свою сумку..*]],
            speaker = [[Перекуп]],
            npc = "npc_perekup",
            choices = {
                {
        ...
        d_porazhen_umom_svinopasa = {
            text = [[*Злость распирает его. Вены на сжатых руках начали сильно выпирать.*
Какое-то ничтожество смогло обойти величайшего гения в математике?! Я не смогу отмыться от этого позора ещё долгое время... Ты обязан заплатить за такое издевательство!]],
        ...
        d_pochemu_vy_dali_mne_chast_klucha = {
            text =
            [[Я же говорила, что один человек попросил передать это кому-то с непоколебимой волей. До тебя приходили одни слабаки, а прикоснувшись к твоему духу, у меня аж мурашки пошли. Хе-хе.]],
            speaker = [[Старушка]],
            npc = "npc_shamanka",
            choices = {
                {
...
Нееет, я пожалуй тут останусь... И давай, чтоб ты не рисковал, я тебе за 140 отдам, а?]],
        ...
        d_prijti_nepodgotovlennym_v_getto_opasno_takto = {
        ...
        d_skazhi_hotya_by_gde_byl_ubit_korol_ya_by_osmotrelsya = {
            text = [[*Он не понял смысла твоего вопроса, его поднятая вверх правая бровь намекала на это.*
Никто не знает, где это было. Никто даже не находил его труп. Дерек явно попытался скрыть его тело, однако это не поможет ему избежать наказания...]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_spasibo_za_prohodku_konechno_no_o_chem_byl_nash_proshlyj_razgovor = {
            text = [[Это была и есть проверка. Те, кто обладают качествами, попадают в Скрытую Академию.]],
            speaker = [[Крип-загадка]],
            npc = "npc_mystery",
            choices = {
                {
                    text = [[Ты - член академии. А по факту то кто?]],
                    next = "d_ty_chlen_akademii_a_po_faktu_to_kto",
                },
            },
        },
        d_spasibo_bro = {
        ...
        d_tam_za_dveru_sluchajno_ne_korallovyj_les = {
            text =
            [[Да. Чтобы открыть её, подойди поближе и произнеси заклинание вслух: "Stringus Collapsus". Будет отлично, если сможешь заодно освободить и эти территории.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_togda_predlagau_torg = {
            text =
            [[*Уверенный в своих умениях перекуп одобрительно кивает. Его большая улыбка подразумевает, что он в этом деле про.*]],
            speaker = [[Перекуп]],
            npc = "npc_perekup",
            choices = {
                {
        ...
        d_tolko_umnyj_sposoben_vyslushat_i_vzvesit_vse_za_i_protiv_a_ty_prosto_upertyj_suchara = {
            ...
            choices = {
                {
                    text =
                    [[И знаешь ли, мой кулак дробит камни, а тут передо мной глыба. Так что последний шанс пойти со мной.]],
                    next =
                    "d_i_znaesh_li_moj_kulak_drobit_kamni_a_tut_peredo_mnoj_glyba_tak_chto_poslednij_shans_pojti_so_mnoj",
                },
            },
        },
        d_tupanul_nemnogo_napomni_a = {
            text =
            [[*Он рассмеялся. Тебе стало неловко, но потом ты впитал ментальный урон и выпустил в виде пара. Из носа, конечно же.*
Если верить словам отшельника, первая часть ключа находятся у старушки, вторая – на одном из пиков Снежных гор, третью же оберегают челюсти чудовища Искаженного леса.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_ty_chlen_akademii_a_po_faktu_to_kto = {
        ...
        d_ty_ved_zelenyj = {
            ...
            choices = {
                {
                    text = [[Тогда как ты мог его забыть? А братьев может помнишь: Красного и Синего?]],
                    next = "d_d",
                },
                {
                    text = [[Он ждёт тебя дома.]],
                    next = "d_d",
                },
            },
        },
        d_ty_debil = {
            text = [[*Он вздохнул с возмущением.*
Обыкновенное поведение примата: использование нецензурной брани в целях показать своё превосходство, однако этим ты только подтверждаешь своё невежество.]],
            speaker = [[Крип-гений]],
            npc = "npc_genius",
            choices = {
                {
...
*Усач демонстративно поднимает гантелю мизинцем. Тридцать раз.*]],
            speaker = [[Человек-усач]],
            npc = "npc_mustache",
            choices = {
                {
        ...
        d_ty_tupovat_tak_chto_zabej = {
            text = [[*Существо поворачивает голову в твою сторону. Это первый раз, когда оно совершило движение.*]],
            speaker = [[Зелёный]],
            npc = "npc_green",
            choices = {
                {
                    text = [[Только умный способен выслушать и взвесить все за и против, а ты просто упёртый сучара.]],
                    next = "d_tolko_umnyj_sposoben_vyslushat_i_vzvesit_vse_za_i_protiv_a_ty_prosto_upertyj_suchara",
                },
            },
        },
...
Это очень мало, знаете ли...]],
        ...
        d_horosho_horosho_ya_kstati_tozhe_tuda_pojdu = {
            text = [[Но как??]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
        ...
        d_chto__2 = {
            text =
            [[*У тебя участилось дыхание, воздух перестал поступать в лёгкие, но тебя это даже впирает. Ты всё ещё не можешь принять того, что видишь.*]],
            speaker = [[...]],
            npc = nil,
            choices = {
                {
        ...
        d_chego_chego = {
            text = [[*Его мелкие ручонки стряхнули пыль с плеч.*
Всё чётко, хоть и синие мальчики гоняются за мной, ты не трясись, всё холодное.]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
        ...
        d_chutchut = {
            text =
            [[Долгое время я не мог решиться... С одной стороны, утаивание ключа - благое действие, однако бесчестное. С другой, бой с Дереком - это страшная смерть...]],
            speaker = [[Отшельник]],
            npc = "npc_hermit",
            choices = {
                {
        ...
        d_em_dopustim = {
            text =
            [[Первую часть я отдал старушке-медиуму, вторую - спрятал на соседнем пике Снежных гор, а третью - скормил самому могучему крипу Искажённого леса.]],
            speaker = [[Отшельник]],
            npc = "npc_hermit",
            choices = {
                {
                    text = [[Понятно.]],
                    next = "d_hermit_i_get_it",
                },
            },
        },
        d_eto_ego_mechta_poslednee_chto_derzhit_deda_na_etoj_zemle = {
            text = [[*Перекуп помотал головой.*
Так уж и быть... Ради твоего дедушки - 50 золота.]],
            speaker = [[Перекуп]],
            npc = "npc_perekup",
            choices = {
                {
        ...
        d_eto_nepravilnyj_otvet = {
            text =
            [[Ты этого даже без меня не смог понять... Таким пустоголовым ничтожествам нету места в Скрытой Академии. Позволь спасти тебя от страданий...]],
            speaker = [[Крип-гений]],
            npc = "npc_genius",
            choices = {
                {
...
Он сам меня отпустил.]],
        ...
        d_ya_gotov_pomoch = {
            text = [[*Его лёгкая улыбка заставила улыбнуться и тебя.*
Прекрасно. Перед тем как продолжить, хочу рассказать кое что о нашем Короле, Джордже Богоподобном...
*Он произносит это с огромной гордостью.*]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_ya_zabyl_gde_nahodyatsya_chasti_klucha = {
            text = [[*Глава сильно удивился.*
Всмысле забыл? Ты же сам мне рассказал об этих местах...]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
                    text = [[Тупанул немного, напомни а.]],
                    next = "d_tupanul_nemnogo_napomni_a",
                },
            },
        },
        ...
        d_vzyat_novyj_kamen = {
            text =
            [[Как разберёшься с Зверем, мы вместе начнём разгадывать тайны этого мира и в полной мере раскроем концепт равноценного обмена!
*Его культяпки закрутились сильнее обычного.*]],
            speaker = [[Учёный]],
            npc = "npc_scientist",
            choices = {
                {
        ...
        d_pechalno_eto_uzhe_ne_pervyj_raz_kak_krip_chtoto_zabyvaet_mozhet_eto_v_ih_prirode_tak = {
            text =
            [[*Ты осчастливил его, так пусть кайфует. Ты решаешься просто идти дальше. На этом ваши пути расходятся.*]],
            speaker = [[Крип-нигер]],
            npc = "npc_dream_golden",
            choices = {
                {
        ...
        d_podslushat = {
            text =
            [[So I hit the corner shop the other day, you understand? I had to get some blunts, you feel me? I'm gettin' a high. I slide back to the crib then a little ho call me, she talkin about i'm tryin' slide thru. I said, "shiit, if you tryin to give me that, man", you feel me so...]],
            speaker = [[Крип-нигер]],
            npc = "npc_dream_golden",
            choices = {
                {
        ...
        d_rasskazat_o_sobytiyah_v_getto = {
            text =
            [[Yoooo, это дерьмо пахнет. Props to you, ты реально самый дикий и крутой кекс, что я встречал. Dawg, никогда не забуду твою помощь и любовь.]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
        ...
        d_u_nego_vse_horosho_luchshe_ya_pojdu = {
            ...
            choices = {
                {
                    text = [[*Что с ним?*]],
                    next = "d_dream_whats_up_with_him",
                },
            },
        },
        d_hmm_opyat_etot_ostrov_epshtejn_ne_promah_on_mozhet_ustroit_kakuuto_lovushku = {
            ...
            choices = {
                {
                    text = [[*Да... скорее всего ты прав, пойду туда, только когда стану сильнее.*]],
                    next = "d_da_skoree_vsego_ty_prav_pojdu_tuda_tolko_kogda_stanu_silnee",
                },
            },
        },
...
Ура!!!!!!!!]],
        ...
        d_untitled_passage_27_merged_act3 = {
            text =
            [[*Увидев тебя, пузатый крип начал кидать распальцовку. Его походка изменилась, он начал чувствовать.*]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
        ...
        d_untitled_passage_42_merged_act3 = {
            text =
            [[*Гангстер останавливает тебя. Кухонные ножи в его руках выглядят забавно, но ты понимаешь, что один такой тычок и тебе конец.*
Чего белозадый забыл у нас? Проблем хочешь?]],
        ...
        d_untitled_passage_47_merged_act3 = {
            text = [[*Истекая кровью, крип сквозь зубы выдавливает последние слова.*
Я вас всех подвёл...]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
...
*Задорно отозвался звук из динамиков.*]],
            speaker = [[Эпштейн]],
            npc = nil,
            choices = {
                {
...
*От громких выкриков, часть звуков из динамиков пропала*]],
            speaker = [[Эпштейн]],
            npc = nil,
            choices = {
                {
        ...
        d_untitled_passage_54 = {
            text =
            [[*Две демонические фигуры прямо перед тобой. Их тела отбрасывают странную тень, есть ощущение, что она двигается сама по себе.*
Испорченная душа... В тебе виднеется потенциал.]],
            speaker = [[Демоны Тени]],
            npc = "npc_island_demon",
            choices = {
                {
        ...
        d_untitled_passage_58 = {
            text = [[*Ты закладываешь бомбу рядом с оборудованием. Этого точно хватит, чтоб подорвать весь остров.*]],
            speaker = [[...]],
            npc = "npc_bomb_place",
            choices = {
                {
        ...
        d_untitled_passage_61_merged_act3 = {
            text =
            [[Ты возьмёшь взрывчатку, отправишься на остров и пройдешь через секкретный проход в деревьях. Поставишь бомбу и, пройдя полосу, вернёшься через М.Е.Т.Р.О. Готов?]],
            speaker = [[Кот-бочка]],
            npc = "npc_cat_barrel",
            choices = {
                {
        ...
        d_untitled_passage_63_merged_act3 = {
            text =
            [[*Услышав шаги, учёный моментально вычислил, что идёшь именно ты, обратя внимание на звук, вес и плотность твоих шагов, относительно пола.*
Умнейший на подходе! Приветствую, Алекс. Глава сообщил, что тебе нужен Философский камень, верно?]],
            speaker = [[Учёный]],
            npc = "npc_scientist",
            choices = {
                {
        ...
        d_untitled_passage_64_merged_act3 = {
            text = [[Кстати, Алекс, замечал какие у нас стены в Академии?]],
            speaker = [[Учёный]],
            npc = "npc_scientist",
            choices = {
                {
        ...
        d_untitled_passage_65_merged_act3 = {
            text =
            [[*Ты чувствуешь, что, перед тем как отдать ключ, стоит подготовиться. Возможно, стоит доделать оставшиеся дела.*]],
            speaker = [[...]],
            npc = nil,
            choices = {
                {
        ...
        d_dream_dont_get_it = {
            text = [[Как кличить тебя, кекс. Ты trippin' или как?
*Он ведёт себя так, будто видит тебя впервые. Но почему?*]],
            speaker = [[Крип-нигер]],
            npc = "npc_dream_golden",
            choices = {
                {
                    text = [[Я? Ты же знаешь.]],
                    next = "d_ya_ty_zhe_znaesh",
                },
            },
        },
        d_dream_whats_up_with_him = {
            text = [[*Крип-нигер подходит к тебе.*
Wazup, ты кем будешь, dawg?]],
            speaker = [[Крип-нигер]],
            npc = "npc_dream_golden",
            choices = {
                {
                    text = [[Не понял.]],
                    next = "d_dream_dont_get_it",
                },
            },
        },
        d_dream_whats_wrong = {
        ...
        d_g17 = {
            ...
            choices = {
                {
                    text = [[*Панда называл его Непредсказуемым болваном. Я бы просто назвал Долбоёбом.* ]],
                    next = "d_g9",
                },
            },
        },
        ...
        d_n2 = {
            text =
            [[После, из деревьев вышли какие-то фигуры и связали нас, бросив в клетку. Мы ничего не видели, однако уверены, там что-то важное.]],
            speaker = [[Кот-бочка]],
            npc = "npc_cat_barrel",
            choices = {
                {
...
Л..Ладно извини за всё, я реально вёл себя плохо. Что я могу сделать для тебя, милый Алекс?]],
            speaker = [[Эпштейн]],
            npc = "npc_bomb_place",
            choices = {
                {
        ...
        d_r10 = {
            ...
            choices = {
                {
                    text = [[Что-то не так?]],
                    next = "d_dream_whats_wrong",
                },
            },
        },
        d_r11 = {
            text =
            [[Братья, надеюсь вы все сейчас в гангстерском раю... Вы должны были жить... Я отомщу ради вас! Главное дождитесь меня!!]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
        ...
        d_r15 = {
            text =
            [[Ты постоянно что-то делаешь, однако не можешь выложиться на полную, ведь у тебя нету на то причины.]],
            speaker = [[Человек-усач]],
            npc = "npc_mustache",
            choices = {
                {
...
*Потягивает ус.*]],
        ...
        d_r5 = {
            text = [[*Гангстер крикнул на всё гетто.*
БРАТКИ! У нас тут мазафакер попался, снимайте с него штаны сейчас же!]],
            speaker = [[Гангстер]],
            npc = "npc_gangster",
            choices = {
                {
        ...
        d_r7 = {
            text = [[*Он резко подлетел к тебе и крепко обнял. В его руках всё ещё были ножи.*
Братва, похоже к нам альбиноса подкинули! Теперь это твой дом, запомни.]],
            speaker = [[Гангстер]],
            npc = "npc_gangster",
            choices = {
                {
...
С гордостью отдаём его, пусть он поможет привести нас всех к миру!]],
        ...
        d_s1 = {
            ...
            choices = {
                {
                    text = [[Космического... это что ли тот метеорит?]],
                    next = "d_kosmicheskogo_eto_chto_li_tot_meteorit",
                },
            },
        },
        d_s2 = {
        ...
        d_u5 = {
            text =
            [[So the sucka said "give me that shit!" So i already have my phone with me bruh. Nga ain't even had stick on the floor so i pulled out my fucka and said "pussy ass nga we're good". I'm talkin about this nga ass nga ran off fr, you know what i'm talkin about?]],
            speaker = [[Крип-нигер]],
            npc = "npc_dream_golden",
            choices = {
                {
        ...
        d_u6 = {
            text =
            [[So I ain't even had to call my demon G, I ain't even had to call my real nga, you understand me? My my young demon G wasn't even at home at the time so I couldn't even call him if i wanted to, but i had this shi myself like a real hood nga, you understand me?]],
            speaker = [[Крип-нигер]],
            npc = "npc_dream_golden",
            choices = {
                {
        ...
        d_u7 = {
            text =
            [[So youre really tryin to set a young nga up, you understand me? But we all good, we're still here for a bit, young creep-nga, you heard me? I know how i'm rockin.]],
            speaker = [[Крип-нигер]],
            npc = "npc_dream_golden",
            choices = {
                {
...
Ооуоэъх... Ты всё увидишь, мой хоуми. Как всё прошло?]],
        ...
        d_vzorvem_epshtejna = {
            ...
            choices = {
                {
                    text = [[*Хмм... опять этот остров. Эпштейн не промах, он может устроить какую-то ловушку.*]],
                    next = "d_hmm_opyat_etot_ostrov_epshtejn_ne_promah_on_mozhet_ustroit_kakuuto_lovushku",
                },
            },
        },
        d_vizhu_kontsert_poshel_na_polzu = {
            text = [[Бро, это дерьмо вдарило мне в голову, словно пипы втянули колли.
*Если бы на нём были штаны, то были бы уж точно спущенными.*]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
...
Что готово?]],
        ...
        d_da_nichego_takogo = {
            text = [[*С тоской в голосе говорит кот-бочка.*
Мы попались на такую примитивную ловушку. Вечный позор нам. А ведь мы даже не знаем кто такая цмка...
*Все крипы поникли в лице.*]],
        ...
        d_davaj_bez_etogo = {
            text = [[Думаешь у тебя есть выбор, а?]],
            speaker = [[Гангстер]],
            npc = "npc_gangster",
            choices = {
                {
...
Чтоб белый вступил в C.R.E.E.P.s.? Ты гонишь а.]],
        ...
        d_demony_zvuchit_interesno = {
            text = [[Ладно. Я понял.
*Эпштейн понизил голос и начал говорить очень медленно.*
Участь страшнее смерти ожидает тебя за поворотом. Удачи.]],
            speaker = [[Эпштейн]],
            npc = nil,
            choices = {
                {
        ...
        d_dumau_hvatit = {
            text =
            [[*Сжав булки, ты создал небольшую вспышку, уничтожив Тень. Твоя душа настолько чиста и сильна, что ты одной лишь силой воли смог остановить перевоплощение в демона и сохранить свой рассудок.*]],
            speaker = [[Демоны Тени]],
            npc = "npc_island_demon",
            choices = {
                {
                    text = [[Ооохх... я сейчас начну стрелять лазерами из глаз.]],
                    next = "d_ooohh_ya_sejchas_nachnu_strelyat_lazerami_iz_glaz",
                },
            },
        },
        d_esli_by_v_tvoih_slovah_hot_inogda_poyavlyalas_logika_i_smysl_vse_bylo_by_norm = {
        ...
        d_i_kak_byt = {
            text =
            [[Когда был на концерте, услышал от двух gangsta, что, пока остальные were ballin', они сгоняли и притащили партию broccoli и нескольких chassie, за что их респектнул сам mack! В благодарность он отсыпал им капусты, тек найн и дал LEAN, hell yeah!]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
...
*Сегодня ты сделал Эпштейна своей собачкой, кому скажешь, не поверят.*]],
            speaker = [[Эпштейн]],
            npc = "npc_bomb_place",
            choices = {
                {
        ...
        d_kosmicheskogo_eto_chto_li_tot_meteorit = {
            text =
            [[Да! Один наш житель, очень важная персона, отправился в Заброшенный лес и с помощью кучи Философских камней переделал куски метеорита в наши здания. Наука прекрасна!]],
            speaker = [[Учёный]],
            npc = "npc_scientist",
            choices = {
                {
...
Давай же, Исчадие Тени, одолеем его ради нашего хозяина. Мы перед ним в неоплатном долгу.]],
        ...
        d_ne_ponyal_ya_odin_pojdu = {
            text = [[Подумай.
*Он постукивает пальцем себе по голове.*
Ты единолично одолел сильнейших существ этого мира, никто из людей и близко не доходил до такого уровня силы. Ты, и только ты способен избавить эту землю от чумы, именуемой Дереком.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
                    text = [[Я реально жёсткий, дааа... ну хорошо.]],
                    next = "d_ya_realno_zhestkij_daaa_nu_horosho",
                },
            },
        },
        d_ne_smotrel = {
        ...
        d_odin_raz_sbezhal_smogu_i_vtoroj = {
            text = [[*Он похихикал.*
У нас здесь небольшое изменение. Я добавил улучшение на полосу, думаю ты по достоинству оценишь!]],
            speaker = [[Эпштейн]],
            npc = nil,
            choices = {
                {
                    text = [[Да мне без разницы так-то.]],
                    next = "d_da_mne_bez_raznitsy_takto",
                },
            },
        },
        d_on_sobran = {
...
Отличная работа, Алекс. Большой же ты путь проделал, сложный и опасный, и в итоге предо мной - самый великий воин Королевства. Я официально присуждаю этот титул.]],
        ...
        d_ooohh_ya_sejchas_nachnu_strelyat_lazerami_iz_glaz = {
...
Как это вообще возможно? Никому не удавалось заполучить преимущества Тени и при этом остаться человеком.]],
        ...
        d_ponyatnoe_delo_govorya_s_toboj_nevozmozhno_ponyat_chto_proishodit = {
            ...
            choices = {
                {
                    text = [[Если бы в твоих словах хоть иногда появлялась логика и смысл, всё было бы норм.]],
                    next = "d_esli_by_v_tvoih_slovah_hot_inogda_poyavlyalas_logika_i_smysl_vse_bylo_by_norm",
                },
            },
        },
...
Отправляйся сейчас же и прояви мужество на поле боя, борись до конца, не давай ему шанса на передышку, действуй непредсказуемо и бейся как в последний раз. Ради своего будущего, руди будущего Королевства.]],
        ...
        d_prishlos_vstupit_v_ih_bandu_radi_etogo = {
            text =
            [[Damn!! Оказывается я не единственный теперь BG! Можешь вдоволь полаять, я с радостью послушаю твой bomb ass story.]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
        ...
        d_prishlos_inache_by_umer_sam = {
            text =
            [[Н-но... Зачем мне теперь жить... Ведь гетто это было единственным местом, куда я хотел попасть, а теперь его нету!]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
        ...
        d_radi_blagoj_tseli_rad_byl_postaratsya = {
            text = [[*Он начал подпрыгивать.*
Ты сделал из хастлера - настоящего гангстера!]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
        ...
        d_respekt_vam = {
            text =
            [[Хотел немного lean, да? Иди и возьми немного, расслабишься. Кстати, не забудь штаны приспустить, ну... или то, что у тебя на ногах, хах!]],
            speaker = [[Гангстер]],
            npc = "npc_gangster",
            choices = {
                {
...
Я же говорил, что запрещено рассказывать о камне простым людям. Зачем ты это сделал?]],
        ...
        d_smozhem_dogovoritsya = {
            text = [[*Он наводит нож в твою сторону.*
Покажи-ка свой кошель.]],
            speaker = [[Гангстер]],
            npc = "npc_gangster",
            choices = {
                {
...
*Крипы в предвкушении. Фейерверки теперь повёрнуты не в твою сторону, а вверх.*]],
        ...
        d_taaak = {
            text =
            [[Сможешь достать его? С линчиком я стану тру гэнгста, сам пойти не могу, рано ещё с ними бифиться, а ты вот запросто вольёшься в их флоу.]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
        ...
        d_ty_voshel_vo_vkus = {
            text =
            [[Всё благодаря тебе, мой OG. Этот чёрный пёс на сцене показал молодому хаслеру crazy стаф, его строчки просто взорвали моё средце boo-yaa.]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
        ...
        d_ty_teper_pojdesh_v_getto = {
            text =
            [[Um, я всё ещё простой thug, сечёшь? Те мазафакеры сразу поймут, что я buster, и закличут блэйдом... Я даже ни разу не тегал, you know...]],
            speaker = [[Крип с мечтой]],
            npc = "npc_dream",
            choices = {
                {
        ...
        d_schekotno = {
            text =
            [[*Ты чувствуешь ненормальный прилив сил, что-то чёрное начало струиться по твоим венам, а очи твои покраснели.*]],
            speaker = [[Демоны Тени]],
            npc = "npc_island_demon",
            choices = {
                {
        ...
        d_em_vrode_net = {
            text = [[*Мордочка кота-бочки стала недовольной, а уши прижались.*
Это не круто, мистер, а если мы заденем кого-нибудь, не думали?]],
            speaker = [[Кот-бочка]],
            npc = "npc_cat_barrel",
            choices = {
                {
...
*Крипы кланяются тебе. Ты стал их кумиром.*]],
        ...
        d_ya_realno_zhestkij_daaa_nu_horosho = {
...
*Глава начал молиться.*]],
        ...
        d_ya_serezno = {
            text =
            [[*Гангстер достал косяк и сочно закурил. Прошла минута, потом две. Все молчали и ждали, пока он закончит. Ты решил последовать их примеру.*
Знаешь, а было бы забавно. Но вот только ты должен доказать, что внутри тебя душа нигера, понял?]],
            speaker = [[Гангстер]],
            npc = "npc_gangster",
            choices = {
                {
        ...
        d_ya_ty_zhe_znaesh = {
            text = [[*Он помахал головой.*]],
            speaker = [[Крип-нигер]],
            npc = "npc_dream_golden",
            choices = {
                {
                    text = [[*Печально. Это уже не первый раз, как крип что-то забывает, может это в их природе так...*]],
                    next = "d_pechalno_eto_uzhe_ne_pervyj_raz_kak_krip_chtoto_zabyvaet_mozhet_eto_v_ih_prirode_tak",
                },
            },
        },
        d_yajtsa = {
        ...
        d_vosstanovit_dyhanie = {
            text = [[Больше не придётся страдать... Больше не придётся причинять страдания…]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
                    text = [[Мы не закончили.]],
                    next = "d_my_ne_zakonchili",
                },
            },
        },
        d_gluboko_vdohnut = {
            ...
            choices = {
                {
                    ...
                    next = "d_postavit_podnozhku",
                },
                {
                    text = [[Здарова, пидрила.]],
                    next = "d_zdarova_pidrila",
                },
            },
        },
        d_oklematsya = {
            text = [[Похоже я заслужил это.
*Очень тихо сказал Дерек.*]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
                    text = [[*Подготовить удар.*]],
                    next = "d_podgotovit_udar",
                },
            },
        },
        d_otdyshatsya = {
...
*Очень тихо сказал Дерек.*]],
            ...
            choices = {
                {
                    text = [[*Восстановить дыхание.*]],
                    next = "d_vosstanovit_dyhanie",
                },
            },
        },
        d_podgotovit_udar = {
            text = [[Стой...
*Говорит он через силу.*
Есть важная вещь, которую кто-то должен знать. Пусть это будешь ты...]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
            ...
            choices = {
                {
                    ...
                    next = "d_potushit_ob_nego_sigaru",
                },
            },
        },
...
*Невероятно громко выкрикнул огромный скелет.*]],
            ...
            choices = {
                {
                    text = [[Реально живой.]],
                    next = "d_realno_zhivoj",
                },
            },
        },
        d_prishlo_vremya_nakazyvat = {
        ...
        d_rad_chto_srabotalo = {
            text = [[*Вдруг в коридоре послышался едва заметный хлопок. Взрыв? Выстрел?*]],
            speaker = [[...]],
            npc = nil,
            choices = {
                {
                    text = [[*Пришло время наказывать.*]],
                    next = "d_prishlo_vremya_nakazyvat",
                },
            },
        },
        ...
        d_ty_beresh_s_pola_kamen_i_brosaesh_v_sooruzhenie = {
            text = [[РАВНОЦЕННЫЙ ОБМЕН - ОСНОВА ЭТОГО МИРА.]],
            speaker = [[БОГ]],
            npc = "npc_tormentor",
            choices = {
                {
                    text = [[Да, да, это уже слышал. Хочу совершить обмен.]],
                    next = "d_da_da_eto_uzhe_slyshal_hochu_sovershit_obmen",
                },
            },
        },
        d_eto_realno_ploho = {
        ...
        d_u2__1 = {
            text =
            [[ОДНАЖДЫ, В ЛЕСУ, Я НАШЁЛ ЧЬИ-ТО ЗАПИСИ, В НИХ РАССКАЗЫВАЛОСЬ, ЧТО ЗДЕСЬ ЕСТЬ БОГ, ПРИКИНЬ?! ХА-ХА-ХА.]],
        ...
        d_u6__1 = {
            text =
            [[НО БЫЛА ВЕЩЬ, КОТОРУЮ Я НЕ УЧЁЛ: ЛЮДЕЙ БЫЛО НЕЧЁТНОЕ КОЛИЧЕСТВО, ПОЭТОМУ ОДИН УПЫРЬ ОСТАЛСЯ В СОЗНАНИИ. ТЕПЕРЬ ИЗ-ЗА НЕГО Я ГНИЮ В ЭТОЙ ПЕЩЕРЕ! ТВАРИНА!]],
            speaker = [[Джордж Богоподобный]],
            npc = "npc_george",
            choices = {
                {
        ...
        d_u7__1 = {
            text = [[ЧЕМ ТЫ ЖЕРТВУЕШЬ.]],
            speaker = [[БОГ]],
            npc = "npc_tormentor",
            choices = {
                {
                    text = [[Не не не, стоп. Не надо отвечать. Сделка закрыта.]],
                    next = "d_ne_ne_ne_stop_ne_nado_otvechat_sdelka_zakryta",
                },
            },
        },
        d_untitled_passage_merged_act4 = {
            text = [[*Зверь пал. Вся ярость исчезла, теперь это просто груда мышц.*]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_untitled_passage_1_merged_act4 = {
            text = [[Перед массивной дверью стоит алтарь с выемкой странной формы...]],
            speaker = [[...]],
        ...
        d_untitled_passage_2_merged_act4 = {
            ...
            choices = {
                {
                    text = [[Положить ключ.]],
                    next = "d_polozhit_kluch",
                    actions = {
                        { itemName = "item_key", type = "take_item" },
                        { door = "door_derek", type = "open_door" },
                    },
                },
            },
        },
        d_untitled_passage_67_merged_act4 = {
            text = [[*Девушка умиротворённо медитирует.*]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
                    text = [[Ты мне враг?]],
        ...
        d_untitled_passage_70_merged_act4 = {
            text =
            [[*Перед тобой стоит грозный человек с рельефным, но израненным телом. Большое количество шрамов наводит на определённые мысли. Аура, которую он излучает, словно отталкивает тебя. Есть ощущение, что стены сжимаются.*]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
            ...
            choices = {
                {
                    ...
                    next = nil,
                    actions = {
                        { pack = "pack_george", type = "fight_start" },
                    },
                },
            },
        },
        d_untitled_passage_79_merged_act4 = {
            text = [[*Ты смотришь на золотую постройку. Здесь всё началось.*]],
            speaker = [[...]],
            npc = "npc_tormentor",
            choices = {
                {
                    text = [[Я хочу совершить сделку.]],
                    next = "d_ya_hochu_sovershit_sdelku",
                },
            },
        },
        d_untitled_passage_80_merged_act4 = {
            text = [[*Не хочу думать об этой штуке, пора домой.*]],
            speaker = [[...]],
            npc = "npc_tormentor",
            choices = {
                {
        ...
        d_untitled_passage_81_merged_act4 = {
            text = [[Алекс, почему ты так избит?
*Взволнованно спросила гид.*]],
            speaker = [[Гид]],
            npc = "npc_guide",
            choices = {
                {
                    text = [[Скажи всем, что портал открыт.]],
                    next = "d_skazhi_vsem_chto_portal_otkryt",
                },
            },
        },
        d_untitled_passage_82_merged_act4 = {
        ...
        d_untitled_passage_84_merged_act4 = {
            text =
            [[*Этот готов. В коридрое всё ещё слышны выстрелы, похоже он пришёл не один. Пришло время выносить мусор.*]],
            speaker = [[...]],
            npc = "npc_shooter_ending",
            choices = {
                {
                    ...
                    actions = {
                        ...
                        { pack = "pack_shooter_hall_4", type = "fight_start" },
                        { pack = "pack_shooter_hall_5", type = "fight_start" },
                    },
                },
            },
        },
        ...
        d_derek_names_alex = {
            ...
            choices = {
                {
                    text = [[Я пришёл даровать тебе наказание.]],
                    next = "d_ya_prishel_darovat_tebe_nakazanie",
                    actions = {
                        { var = "derek_kill", value = true, type = "set_var" },
                    },
                },
                {
        ...
        d_derek_phase_2_start = {
            text = [[*Дерек истощён. Силы покидают его.*]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_g34 = {
            text =
            [[В страхе перед его сущностью, я запер вход в то место. Даже представить не могу, что с ним сейчас...]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
                    text = [[Бессмертный... Я бы взглянул на это.]],
                    next = "d_bessmertnyj_ya_by_vzglyanul_na_eto",
                },
            },
        },
        d_george_phase_2_start = {
            text = [[*От твоих ударов его начало потряхивать.*
ХА-ХА-ХА, ОЧЕНЬ ХОРОШО! ТЫ МЕНЯ РАЗЗАДОРИЛ!]],
            speaker = [[Пропавший Король]],
            npc = "npc_george",
            choices = {
                {
                    text = [[Может поговорим просто?]],
                    next = "d_mozhet_pogovorim_prosto",
                },
            },
        },
        d_guide_last_close = {
        ...
        d_s10 = {
            text = [[Хм... Это не ты. Назовись.]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
                    text = [[Алекс.]],
                    next = "d_derek_names_alex",
                },
            },
        },
        d_s3 = {
            text =
            [[*Она продолжила медитацию и полминуты сидела неподвижно, однако услышав твои шорохи и поняв, что ты всё ещё тут, продолжила говорить.*
Зачем жителю Королевства вступать в наши земли? Вы же знаете, что тут только разруха, разбойничество и нищета.]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
                    text = [[Я ищу Дерека.]],
                    next = "d_ya_ischu_dereka",
                },
            },
        },
        d_s4 = {
            text = [[Надеюсь у тебя что-то да выйдет, было бы неплохо взглянуть на его труп.]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
                    text = [[А вы не союзники с ним?]],
                    next = "d_a_vy_ne_souzniki_s_nim",
                },
            },
        },
        d_s5 = {
            text = [[Пока Король был на престоле, каждый человек был предан ему, даже мы - жители Пустоши.]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
        ...
        d_s6 = {
            text =
            [[Но в Королество пускали не всех, потому отвергнутые начали гнить здесь. За это мы и ненавидим людей Королевства.]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
        ...
        d_s7 = {
            text =
            [[А когда толпа ваших людей ворвалась сюда с целью казнить Дерека, то мы, просто попрятались. Ты не представляешь сколько там было народу.]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
        ...
        d_s8 = {
            text =
            [[И в тот момент мы решили, что пусть они делают своё дело. Хоть мы и враги, наша любовь к Королю - едина. Дерек совершил великий грех, он должен был умереть.]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
        ...
        d_s9 = {
            text =
            [[Но он как-то выиграл... после чего стал тут жить. За всё время никто не осмелился сразиться с ним. Вот так и живём.]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
        ...
        d_t = {
            text =
            [[Я надеялся, что его смерть дарует всем свободу. Однако ошибочно было полагать, что обычный человек способен противиться неизвестному.]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
                    text = [[Свободу от чего?]],
                    next = "d_svobodu_ot_chego",
                },
            },
        },
        d_t1 = {
        ...
        d_t10 = {
            text = [[А теперь даруй мне покой. Оборви мою жизнь. Я больше не могу нести это бремя...]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_t2 = {
            text = [[Извини, что тебе предстоит испытать смерть ещё раз.
*Дротики, прикреплённые к его левой руке, остры. Крики жертв, падших от его ржавых топоров, вонзаются тебе в голову. Пришло время великой битвы. Смерть всё ещё решает, кто из вас сегодня станет её другом.*]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
                    text = [[*Глубоко вдохнуть.*]],
                    next = nil,
                    actions = {
                        { pack = "pack_derek",        type = "fight_start" },
                        { music = "music.derek.phase1", type = "music_start" },
        ...
        d_t3 = {
            text = [[*Задыхаясь, он выкрикивает.*
Я ХОЧУ ЖИТЬ! БОЛЬ, СТАНЬ ЖЕ МОИМ ПРОВОДНИКОМ!]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
                    text = [[Ещё пытаешься?]],
                    next = "d_esche_pytaeshsya",
                },
            },
        },
        d_t4 = {
            text = [[Знаешь, что самое удивительное? Только на меня не подействовали неизвестные чары Короля...]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_t5 = {
            text =
            [[Я начал всем твердить, что Джордж что-то сделал с ними, но они были ему полностью преданны. Меня постоянно избивали и публично наказывали...]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_t6 = {
            text =
            [[В один день я решился пойти на убийство... Была надежда, что его смерть освободит разум людей от оков, однако… Думаю ты слышал, что, после этого, за мной устроили охоту.]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_t7 = {
            text = [[А я ведь только защищался. Я никого не хотел убивать...]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_t8 = {
            text = [[Я просто хотел жить. Но каждое моё действие делало всё только хуже...]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_t9 = {
            text = [[*Дерек остановил взгляд на своих топорах.*
Знаешь, странная вещь случилась в ту ночь, когда я убил его. Джордж не умирал... Мои атаки продолжали терзать его тело, но он как будто не мог уйти в мир иной.]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_u1 = {
            text =
            [[ПОПАВ В ЭТОТ МИР, Я УВИДЕЛ ПОТЕНЦИАЛ. Я ЗАХОТЕЛ ПРАВИТЬ ЭТИМ МЕСТОМ, ОДНАКО ПОДЧИНЯТЬСЯ НИКТО НЕ ХОТЕЛ, ХОЛОПЫ!]],
            speaker = [[Джордж Богоподобный]],
            npc = "npc_george",
            choices = {
                {
        ...
        d_wastelands_girl_why = {
            text = [[Мне и так хорошо.]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
        ...
        d_x = {
            ...
            choices = {
                {
                    text = [[*Рад, что сработало.*]],
                    next = "d_rad_chto_srabotalo",
                },
            },
        },
        d_x1 = {
            ...
            choices = {
                {
                    text =
                    [[Эй ты, носатый. Давай сразимся. Если драка будет скучной, то тебя пустит по кругу вся аудитория, понял? Погнали!]],
                    next =
...
То есть ты решил вершить судьбы людей, не зная всей истории?]],
            ...
            choices = {
                {
                    text = [[Какой истории?]],
                    next = "d_kakoj_istorii",
                },
            },
        },
        d_a_pochemu_ty_ne_napala_na_menya_ya_zh_iz_korolevstva = {
            text = [[Не хочу.]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
        ...
        d_aktiviruj_portal_postroennyj_pervym = {
            text = [[ЧЕМ ТЫ ЖЕРТВУЕШЬ.]],
            speaker = [[БОГ]],
            npc = "npc_tormentor",
            choices = {
                {
                    ...
                    actions = {
                        ...
                        { var = "made_deal",        value = true, type = "set_var" },
                    },
                },
            },
        },
        d_bessmertnyj_ya_by_vzglyanul_na_eto = {
            text =
            [[Сходи и убедись сам, если хочешь... Та пещера находится у входа в Королевство. Открывается она с помощью слов: "Carcer Immortalium"...]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_da_da_eto_uzhe_slyshal_hochu_sovershit_obmen = {
            text = [[ЧТО ТЫ ХОЧЕШЬ.]],
            speaker = [[БОГ]],
            npc = "npc_tormentor",
            choices = {
        ...
        d_derek = {
            text = [[Всё-таки месть взяла над тобой верх.
*Сказал мужчина громко, но спокойно.*]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
            ...
            choices = {
                {
                    ...
                    next = "d_bylo_by_neploho",
                },
            },
        },
        d_dushoj_korolya_dzhordzhem = {
            text = [[*Он начинает издавать поскрипывающие звуки. Спустя мгновение в Королевстве появляется вспышка.*]],
            speaker = [[БОГ]],
            npc = "npc_tormentor",
            choices = {
                {
                    text = [[Похоже зашло.]],
                    next = "d_pohozhe_zashlo",
                },
            },
        },
        d_esche_pytaeshsya = {
            text =
            [[*Его пот начал становиться паром. Капилляры на глазах полопались. Корчась от боли, он встаёт, оперевшись на ноги и руки одновременно, словно животное. Невероятная воля к жизни даёт ему силы продолжать схватку.
Зверь пробудился.*]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
                    text = [[*Это реально плохо.*]],
                    next = nil,
                    actions = {
                        { type = "derek_transition" },
                    },
                },
            },
        },
...
*Он наводит ствол на тебя и сразу же стреляет.*]],
        ...
        d_kakoj_istorii = {
            text = [[*Она вздохнула.*
Почему в тот день впустили тебя, а не меня?]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
            ...
            choices = {
                {
                    ...
                    next = "d_ladno_no_portal_zhe_ne_rabotaet",
                },
            },
        },
        d_kakuu = {
            text = [[Король... Джордж в пещере у входа в Королевство. Убей его, уничтожь...]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_ladno_no_portal_zhe_ne_rabotaet = {
            ...
            choices = {
                ...
                {
                    text = [[Я не готов жертвовать чужой жизнью.]],
                    next = "d_ya_ne_gotov_zhertvovat_chuzhoj_zhiznu",
                },
            },
        },
        d_mne_bylo_dano_zadanie_ty_dolzhen_ponimat_kakoe = {
            text = [[*Он понимающе кивнул.*
Может ты всё-таки развернёшься и пойдешь домой? В жизни есть много прекрасного, я больше не хочу кого-либо лишать возможности наслаждаться ею. Не хочу лишать твоих близких тебя.]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
                    text = [[Твоё существование - угроза для всех.]],
                    next = "d_tvoe_suschestvovanie_ugroza_dlya_vseh",
                },
            },
        },
        d_mozhet_pogovorim_prosto = {
            text =
            [[ПРОДОЛЖАЙ МЕНЯ ВЕСЕЛИТЬ, ШУТ. Я ХОЧУ ЕЩЁ! СЕЙЧАС ВСПОЛЫХНУ, НЕ ПРЕДСТАВЛЯЕШЬ СКОЛЬКО Я ТОМИЛСЯ ЗДЕСЬ. ПОРА ПОКАЗАТЬ, ПОЧЕМУ МЕНЯ НАЗЫВАЮТ БОГОПОДОБНЫМ.]],
            speaker = [[Пропавший Король]],
            npc = "npc_george",
            choices = {
                {
                    text = [[*Пора заканчивать с этим.*]],
                    next = nil,
                    actions = {
                        { type = "george_transition" },
                    },
                },
            },
        },
        d_my_ne_zakonchili = {
            text = [[Что тебе ещё нужно...
*Говорит он через силу.*]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
                    text = [[От чего ты хотел спасти людей?]],
                    next = "d_ot_chego_ty_hotel_spasti_ludej",
                },
            },
        },
        d_ne_ne_ne_stop_ne_nado_otvechat_sdelka_zakryta = {
            text = [[*Он замолкает.*]],
            speaker = [[БОГ]],
            npc = "npc_tormentor",
            choices = {
        ...
        d_obratno_v_zhizn = {
            text =
            [[*Она немного замешкалась, но вскоре поняла важность твоих слов и отправилась оповещать всех людей.*]],
            speaker = [[...]],
            npc = "npc_guide",
            choices = {
                {
        ...
        d_ot_chego_ty_hotel_spasti_ludej = {
            text = [[Не знаю, есть ли у этого название...]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_pohozhe_zashlo = {
            ...
            choices = {
                {
                    text = [[Зачем тебе души?]],
                    next = "d_u7__1",
                },
                {
                    text = [[Почему Джордж - бессмертный?]],
                    next = "d_u7__1",
                },
                {
...
ОТЛИЧНО, ЭТО БЫЛО ОЧЕНЬ ПРИЯТНО! НАКОНЕЦ РАЗМЯЛ ТЕЛО, МОГУ ОТСЫПАТЬ ЧАШКУ ЗЕРНА, ТЫ ХОРОШИЙ ПЛЕБЕЙ.]],
            ...
            choices = {
                {
                    text = [[Объясни лучше почему ты жив.]],
                    next = "d_u",
                },
            },
        },
        d_prodolzhaj = {
            text =
            [[И из ниоткуда пришёл человек и провозгласил себя королём. По какой-то причине все последовали за ним без вопросов, будто так всегда было...]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_realno_zhivoj = {
            text = [[СМЕРД, СКЛОНИСЬ ПЕРЕД КОРОЛЁМ!]],
            speaker = [[Пропавший Король]],
            npc = "npc_george",
            choices = {
                {
                    text = [[Ты серьёзно так и при жизни говорил?]],
                    next = "d_ty_serezno_tak_i_pri_zhizni_govoril",
                },
            },
        },
        d_s_radostu = {
        ...
        d_svobodu_ot_chego = {
            text = [[Хотел бы и я знать...]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
                    text = [[Мне было дано задание, ты должен понимать какое.]],
                    next = "d_mne_bylo_dano_zadanie_ty_dolzhen_ponimat_kakoe",
                },
            },
        },
        d_skazhi_vsem_chto_portal_otkryt = {
            text = [[Портал? А куда он ведёт?]],
            speaker = [[Гид]],
            npc = "npc_guide",
            choices = {
                {
                    text = [[Обратно в жизнь.]],
                    next = "d_obratno_v_zhizn",
                },
            },
        },
        d_tak_on_mertv = {
...
С твоей силой ты сможешь положить конец его тирании...]],
        ...
        d_tvoe_suschestvovanie_ugroza_dlya_vseh = {
            text = [[*Дерек разочарованно вздохнул.*
Ясно. Извини, что тебе предстоит испытать смерть ещё раз.
*Дротики, прикреплённые к его левой руке, остры. Крики жертв, падших от его ржавых топоров, вонзаются тебе в голову. Пришло время великой битвы. Смерть всё ещё решает, кто из вас сегодня станет её другом.*]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
        ...
        d_teper_ponyatno = {
            text = [[*Она продолжает медитировать.*]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
                    text = [[А почему ты не напала на меня? Я ж из Королевства.]],
                    next = "d_a_pochemu_ty_ne_napala_na_menya_ya_zh_iz_korolevstva",
                },
            },
        },
        ...
        d_ty_ved_znaesh_pochemu_oni_napali_na_tebya = {
            text =
            [[*Его удивлённый, но, в то же время, недвольный взгляд обрушился на тебя. Он воспринял это как провокацию.*
Что за вопрос? Их Король был разорван этими руками. Безжалостно, но быстро.]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_ty_mne_vrag = {
            text = [[Как я для тебя - монстр, так и ты для меня.]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
        ...
        d_ty_serezno_tak_i_pri_zhizni_govoril = {
            text = [[ВЫПУСТИ МЕНЯ, ПРИНЕСИ СЕБЯ В ЖЕРТВУ И ДАРУЙ МНЕ ОСВОБОЖДЕНИЕ!]],
            speaker = [[Пропавший Король]],
            npc = "npc_george",
            choices = {
                {
        ...
        d_ubit_ego = {
            text = [[Итересно, как вы не пали духом после того поражения.]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
                    text = [[Мне нужно сделать это.]],
                    next = "d_s4",
                },
            },
        },
            ...
            choices = {
                {
                    ...
                    next = "d_takoe_chmo_ne_mozhet_pomogat_drugim",
                },
            },
        },
        d_ej_ty_nosatyj_davaj_srazimsya_esli_draka_budet_skuchnoj_to_tebya_pustit_po_krugu_vsya_auditoriya_ponyal_pognali = {
...
А зачем?]],
        ...
        d_ya_prishel_darovat_tebe_nakazanie = {
            text = [[*Он с тоской посмотрел на землю.*
Ясно. Однако я не намерен снова проливать кровь. Мои руки и так несут грех за убийства людей. Сохрани свою жизнь, уходи.]],
            speaker = [[Дерек]],
            npc = "npc_derek",
            choices = {
                {
        ...
        d_ya_hochu_sovershit_sdelku = {
            text = [[*Нет ответа.*]],
            speaker = [[...]],
            npc = "npc_tormentor",
            choices = {
                {
                    text = [[*Ты берёшь с пола камень и бросаешь в сооружение.*]],
                    next = "d_ty_beresh_s_pola_kamen_i_brosaesh_v_sooruzhenie",
                },
            },
        },
        d_untitled_passage_merged_bubbles = {
