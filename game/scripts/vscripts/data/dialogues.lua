...
conditions = {
{ interact="npc_rape_victim",type="interact" },
{ ent_var="first_met_global",value=false,npc="npc_rape_victim",type="ent_var" },
},
},
...
nodes = {
d_novye_ludi = {
text = [[Да, такие как ты. Их не заинтересовала жизнь с нами, потому они обосновались отдельно от нас. В Королевстве сейчас живут только последователи Короля. ]],
speaker = [[Человек-гид]],
choices = {
{
text = [[Понятно.]],
...
text = [[*Тишина. От сильнейшего топтания твои ботинки покрылись чёрной пеленой, но ты этого даже не заметил, ведь взор твой был устремлён в небеса. В результате страстных движений, земля была окрашена тёмными узорами невиданной красоты."]],
speaker = [[default]],
choices = {
{
...
text = [[*Тишина. Лишь эхом отдаётся последняя нота. В это соло была вложена вся душа, что ты и не заметил, как замок отлетел. Словно медиатор, он лежит между указательным и большим пальцами. Ширинку больше, увы, не застегнуть. ]],
speaker = [[default]],
choices = {
{
...
d_untitled_passage_43 = {
text = [[*Огр-громила пал. Он лежит на земле и смотрет в небо. Он понимает, что это скорее всего последний раз, когда он может насладиться существованием.*]],
speaker = [[Огр-громила]],
choices = {
{
text = [[...]],
...
choices = {
{
text = [[Он и вправду очень скучает по тебе, понимаешь? Ему просто хочется, чтобы вы с братьями были вместе.]],
next = "d_on_i_vpravdu_ochen_skuchaet_po_tebe_ponimaesh_emu_prosto_hochetsya_chtoby_vy_s_bratyami_byli_vmeste",
},
},
},
d_a2 = {
...
d_a3 = {
text = [[С тех пор как они перестали слушаться меня, жизнь пошла по дну. Люди меня стороняться и обходят. Жена даже из дома выгнала, представляешь? ]],
speaker = [[Крип-панда]],
choices = {
{
...
d_f = {
text = [[В первом ты преуспел, теперь пришло время показать силу. Если одним ударом ты сможешь сдвинуть меня, так уж и быть - исполню твоё желание. Нападай.]],
speaker = [[default]],
choices = {
{
text = [[Закрыть.]],
...
d_k4 = {
text = [[Кролик спросил: "А ты же выпустишь меня обратно?"Нефилим покачал головой, добавив: "Теперь это - твой дом."]],
speaker = [[default]],
choices = {
{
text = [[...]],
...
d_l10 = {
text = [[И тот дракон харкнул в брата огнём. Я почуял, что он может подгореть, потому плюнул в него, чтоб напугать! Так он и увернулся.]],
speaker = [[Голова_подначка]],
choices = {
{
text = [[...]],
next = "d_l11",
...
d_l11 = {
text = [[Вообще-то это я его спас, оттащив брата за дубину, которой он замахивался. Дракон промахнулся из-за меня!]],
speaker = [[Голова_умнотуп]],
choices = {
{
text = [[...]],
next = "d_l12",
...
d_l12 = {
text = [[2: Никто не поверит в твои бредни, ты слишком медлительный для такого!1: Я вообще не помню, чтоб ты что-то делал. Значит ты этого не делал!]],
speaker = [[Крип-сиамский_огр]],
choices = {
{
...
d_l13 = {
text = [[1: Брат сказал, что сделает нас умнее. Он отправился искать Мантию на интеллект.2: Хотя куда умнее то!]],
speaker = [[Крип-сиамский_огр]],
choices = {
{
text = [[Что за Мантия?]],
...
d_l5 = {
text = [[*2-ая голова начала говорить пискляво и резко.*А колёса твои где? Хихи хи. Неужто уже зима, на лыжи пересел?]],
speaker = [[Голова_подначка]],
choices = {
{
text = [[...]],
...
d_m5 = {
text = [[*Несколько минут ты смотришь на его труп. В мылсях мелькают фразы из вашего диалога. Ты решаешься не брать мантию.*]],
speaker = [[Огр-громила]],
choices = {
{
text = [[Закрыть.]],
...
d_m9 = {
text = [[Ты победил в честном поединке.*Сказано это было очень спокойно и уверенно. Он ждёт твоих действий.*]],
speaker = [[Огр-громила]],
choices = {
{
...
d_n2 = {
text = [[После, из деревьев вышли какие-то люди и связали нас, бросив в клетку. Мы ниичего не видели, однако уверены, там что-то важное.]],
speaker = [[default]],
choices = {
{
...
d_n8 = {
text = [[*Он впервые занервничал.*Л..Ладно извини за всё, я реально вёл себя плохо. Что я могу сделать для тебя?]],
speaker = [[default]],
choices = {
{
...
d_a_zachem_tebe = {
text = [[Тут неподалёку есть гетто, но там все живут по понятиям, а я ничего не знаю... Даже говорить с ними боюсь, ведь у них своя уникальная манера речи...]],
speaker = [[default]],
choices = {
{
...
d_a_nu_da = {
text = [[Ты возьмёшь взрывчатку, отправишься на остров и пройдешь через секкретный проход в деревьях. Поставишь бомбу и, пройдя полосу, вернёшься через станцию подземных путей. Готов?]],
speaker = [[default]],
choices = {
{
...
d_v_sebe = {
text = [[2: Как можно вообще потеряться в себе, он внутри своей головы живёт?1: Это невозможно. скорее всего он заблудиился.]],
speaker = [[Крип-сиамский_огр]],
choices = {
{
text = [[*Уйти.*]],
...
d_verno = {
text = [[Как вообще я могу быть счастливым, пока они порознь? Это не жизнь. Приходится запивать горе своё. Пока они не воссоединяться, не смогу найти себе места.]],
speaker = [[Крип-панда]],
choices = {
{
text = [[...]],
...
text = [[*1-ая голова начала говорить медленным занудным тоном.*ТЫ... ээээ.. Я Шофёр лимузина. Вожу важных персон. На машине... На конях...]],
speaker = [[Голова_умнотуп]],
choices = {
{
text = [[...]],
...
choices = {
{
text = [[Отец любит тебя, и братья любят. Все ждут тебя. Вернись домой, умоляю тебя. Семья - самое важное на свете.]],
next = "d_otets_lubit_tebya_i_bratya_lubyat_vse_zhdut_tebya_vernis_domoj_umolyau_tebya_semya_samoe_vazhnoe_na_svete",
},
},
},
...
d_da_nichego_takogo = {
text = [[Мы попались на такую примитивную ловушку. Вечный позор нам. А ведь мы даже не знаем кто такая цмка...*Все крипы поникли в лице.*]],
speaker = [[default]],
choices = {
{
text = [[Я тоже попался.]],
...
text = [[Охох, всё содержимое уже во мне.*Панда шлёпает себя по пузу, а потом стучит по бочке, намекая, что она пустая, однако слышно, что в ней ещё немного осталось.*]],
speaker = [[Крип-панда]],
choices = {
{
...
d_kakoj_plan_u_vas = {
text = [[Мы любим мастерить всякие бомбочки, так что хотим взорвать остров!*Крипы по бокам начали запускать петарды от ввозбуждения.*]],
speaker = [[default]],
choices = {
{
...
text = [[*Теневой демон смог успокоить себя..*Давай же, Исчадие тьмы, одолеем его ради нашего хозяина. Мы перед ним в неоплатном долгу.]],
speaker = [[default]],
choices = {
{
text = [[Закрыть.]],
...
d_nu_mogu_da = {
text = [[Мы с ним взрывали петарды в тёмном лесу, как на нас вышел огромный дракон. Он мог летать. С помощью крыльев.]],
speaker = [[Голова_умнотуп]],
choices = {
{
text = [[Ага.]],
...
choices = {
{
text = [[Вы очень разные, но вы все братья. Прими их такими, какие есть, и они проявят уважение и к тебе. Вы снова станете семьёй.]],
next = "d_vy_ochen_raznye_no_vy_vse_bratya_primi_ih_takimi_kakie_est_i_oni_proyavyat_uvazhenie_i_k_tebe_vy_snova_stanete_semej",
},
},
},
d_on_ne_vernetsya = {
...
text = [[*Слово Пустоши повлияло на перекупа.*Нееет, я пожалуй тут останусь... И давай, чтоб ты не рисковал, я тебе за 130 отдам, а?]],
speaker = [[default]],
choices = {
{
...
text = [[Да беда ужасная настигла. У меня есть три сына, понимаешь, а они сбежали от папки своего, не хотят ладить друг с другом. Никак не могу донести до них мысль, что нужно жить всем вместе в гармонии. Тогда и жизнь станет лучше, правда ведь?]],
speaker = [[Крип-панда]],
choices = {
{
text = [[...]],
...
text = [[2: А к тому, что брат захотел нас отблагодарить за спасение... Вот...1: Хоть мы и старше, он сказал, что мы глуповаты. Думаю, он не прав.]],
speaker = [[Крип-сиамский_огр]],
choices = {
{
text = [[Думаю он прав.]],
...
text = [[О нём мало знаю. Мне кажется когда-то я его даже видел... Или нет?.. Вроде кто-то нападал на него. Но когда?]],
speaker = [[Крип-панда]],
choices = {
{
text = [[Спасибо за информацию. Я помогу тебе.]],
next = "d_j10",
actions = {
{ questID="q_pandas",type="quest_start" },
},
...
d_chto_za_korol = {
text = [[*Девушка покраснела*Король... Его зовут Джордж. Джордж Богоподобный. Он лучший человек... Идеальный во всём.]],
speaker = [[Человек-гид]],
choices = {
{
...
text = [[Докажи, что там никого нет. Мы не хотим использовать наше оружие во вред невинным.*Двое по бокам навели на тебя хлопушки.*]],
speaker = [[default]],
choices = {
{
...
d_etot_mir_spasen = {
text = [[Огромное спасибо, мистер. Благодаря тебе, тут стало намного безопаснее. *Крипы кланяются тебе. Ты стал их кумиром.*]],
speaker = [[default]],
choices = {
{
text = [[Закрыть.]],
...
text = [[*Демоны в недоумении.*Как это вообще возможно? Никому не удавалось заполучить преимущества Тени и при этом остаться человеком!]],
speaker = [[default]],
choices = {
{
