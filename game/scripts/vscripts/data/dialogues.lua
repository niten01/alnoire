...
text = [[*Горилла замечает тебя. Огромная туша двигается тебе наствречу. Его огромные яйца звенят друг об друга, словно звон утреннего церковного колокола.*]],
speaker = [[...]],
npc = "npc_gorilla",
choices = {
{
...
text = [[*Бочка разлетелась в дребезги, а содержимое вылилось на твои штаны. Со стороны выглядит так, будто ты обоссался.*
...
d_empty = {
text = [[Вообщем, ты их точно не пропустишь, у них очень выразительные цвета: Красный - злобный малый, Зелёный - твердолобый упырь такой, а Синий - непредсказуемый болван.]],
speaker = [[Пьяная панда]],
npc = "npc_brewmaster",
choices = {
{
...
d_untitled_passage_15 = {
text = [[*Открыв глаза, ты видишь лишь обожённую землю. Золотое сияние неизвестной постройки ослепляет твой взор.*]],
speaker = [[...]],
npc = "npc_tormentor",
choices = {
{
...
d_untitled_passage_23 = {
text = [[*Огромная каменная глыба подзывает тебя. Любое, даже самое небольшое его движение, сотрясает землю под вами обоими.*
...
d_untitled_passage_42 = {
text = [[*Крип причудливой внешности излучает необычайное спокойствие. Его голова туго укатана синей тканью.*]],
speaker = [[Огр-громила]],
npc = "npc_ogre_bruiser",
choices = {
{
...
d_untitled_passage_43 = {
text = [[*Огр-громила пал. Он лежит на земле и рассматривает небо. К нему пришло осознание, что это, скорее всего, последний раз, когда он может насладиться существованием.*]],
speaker = [[Огр-громила]],
npc = "npc_ogre_bruiser",
choices = {
{
...
d_a3 = {
text = [[С тех пор как они стали своевольничать, жизнь пошла по дну. Все знакомые сторонятся меня и обходят. Жена даже из дома выгнала, представляешь?]],
speaker = [[Пьяная панда]],
npc = "npc_brewmaster",
choices = {
{
...
d_a4 = {
text = [[Я думал люди только и могут, что кричать о величии их Пропавшего Короля. Сидят на жопе и ничего кроме этого не делают. Неужто ты мне поможешь?]],
speaker = [[Пьяная панда]],
npc = "npc_brewmaster",
choices = {
{
...
d_i2 = {
text = [[Там обитает Зверь Пустоши, его волосатые ноги меня просто в землю втопчут... Нет ни одного существа, кто ему ровня. Радует, что он не нападает, а только обороняется...]],
speaker = [[Человек-усач]],
npc = "npc_mustache",
choices = {
{
...
d_kk = {
text = [[*Ты слышишь странный звук. Грудь ощущается тяжёлой. Опустив голову вниз, ты замечаешь сквозную дыру. Похоже она попала прям в сердце.*]],
speaker = [[Хранительница]],
npc = "npc_templar_assasin",
choices = {
{
...
d_m5 = {
text = [[*Несколько минут ты смотришь на его труп. В мылсях мелькают фразы из вашего диалога. В итоге, ты не решаешься взять мантию.*]],
speaker = [[Огр-громила]],
npc = "npc_ogre_bruiser",
choices = {
{
...
d_o22 = {
text = [[*Это странно, есть же много способов поднять зелёных. Интересно, что с их умами станет, когда они поймут, что верхушки великих держав подчиняются воле Искрящегося Василиска и вторженцев с Марса?*]],
speaker = [[...]],
npc = nil,
choices = {
{
...
d_o23 = {
text = [[*Её холодная морщинистая рука обхватила твою горячую ладонь. От перепада температур у тебя пошли муражки. Спустя мгновение, бабка, издав небольшой писк, резко отскочила. У тебя зачесался нос. Почему сейчас то?*]],
speaker = [[Старушка]],
npc = "npc_shamanka",
choices = {
{
...
d_o5 = {
text = [[Как вообще я могу быть счастливым, пока они такие непослушные? Это не жизнь, приходится запивать горе своё. Пока они не воссоединяться и не проявят хоть какое-то уважение, не смогу найти себе места.]],
speaker = [[Пьяная панда]],
npc = "npc_brewmaster",
choices = {
{
...
d_p1 = {
text = [[Пока ты был работником сбербанка, я был его директором. Но там было очень легко и скучно, что я решил уволиться и начать заниматься наукой и всего спустя неделю мне выдали Степень Кандидата наук, а потом я изобрёл вечный двигатель, а потом...
...
d_p11 = {
text = [[Ты прав, что-то я забылся! Само понятие Равноценный обмен, по нашим ощущениям, изучено не полностью. Оно несёт что-то очень значимое, а может и смертельно опасное, однако, что именно, мы так всё ещё не поняли... Но из того, что было обнаружено, так это необычное взаимодействие с предметами и материалами.]],
speaker = [[Учёный]],
npc = "npc_scientist",
choices = {
{
...
d_p13 = {
text = [[И ещё. Приходил один странный крип, загадочный. Он просил передать, чтобы ты встретился с ним. Он ожидает тебя где-то здесь, в Королевстве. Удачи!]],
speaker = [[Гид]],
npc = "npc_guide",
choices = {
{
...
d_a_kak_zhe = {
text = [[В Заброшенном лесу проживает крип-предвестник, и каждые 3 года он рассказывает о приближающейся опасности чудовищных масштабов...]],
speaker = [[Гид]],
npc = "npc_guide",
choices = {
{
...
text = [[Будь благодарен тому, что сможешь обучаться этому сейчас! Присоединяйся как-нибудь к нам и станешь умнейшим в этих краях, так и сможешь исследовать эту загадочную вселенную!]],
speaker = [[Учёный]],
npc = "npc_scientist",
choices = {
{
...
text = [[*Красный с энтузиазмом глазеет в твою сторону. Его губы начинают дрожать, новое оскорбление вот вот вылетит из них со свистом. Однако ты делаешь ход раньше.*]],
speaker = [[Красный]],
npc = "npc_red",
choices = {
{
...
d_i_vpravdu_uzhas = {
text = [[Ты показал свою силу, добравшись до сюда живым. Можешь ли ты узнать, какой будет следующая катастрофа, дабы мы были готовы?]],
speaker = [[Гид]],
npc = "npc_guide",
choices = {
{
...
d_nu_kak = {
text = [[Знаешь... лучше. Твои удары усмирили мой гнев. Что-то я уж больно вспылил, даже неприятно вспоминать кем я был минуту назад. 
...
text = [[Ооох, они прекрасные, но в последнее время на них что-то нашло, перестали подчиняться приказам старика. Бывало, даже заставляли меня делать ужасные вещи: воровать, буянить, даже нападать на окружающих... Ох, ужас...]],
speaker = [[Пьяная панда]],
npc = "npc_brewmaster",
choices = {
{
...
text = [[*Помотав глаза из стороны в сторону, он завыл и всё-таки решился поделиться с тобой своей трагедией.*
...
d_chtoto_ne_tak = {
text = [[Скрытая Академия хранит много тайн. Я дала обет, что буду защищать их от чужих глаз. Уходи, если дорога жизнь.]],
speaker = [[Хранительница]],
npc = "npc_templar_assasin",
choices = {
{
...
d_chto__1 = {
text = [[Я дам тебе новый смысл жизни. Так во внемли словам моим! Теперь у тебя есть миссия, Королевству нужен заступник.]],
speaker = [[Старушка]],
npc = "npc_shamanka",
choices = {
{
...
d_eto_zachem = {
text = [[Я способна пробуждать скрытые возможности тела человека. Коснись меня и твоя истинная форма проявится. Быстрее!]],
speaker = [[Старушка]],
npc = "npc_shamanka",
choices = {
{
...
d_poteret_emu_nosik = {
text = [[*Подойдя поближе, ты замечаешь, что его нос сверкает, словно заолотой слиток. Похоже подобное желание приходило в голову многим. Ты начинаешь смачно тереть его нос, прям втирать. Он всё ещё неподвижно наблюдает, но, опустив брови, его взгляд становится более сердитым.*]],
speaker = [[Зелёный]],
npc = "npc_green",
choices = {
{
...
text = [[Вот только мне неоткуда черпать инфу, как таким стать. В Королевстве никто не знает о тонкостях их жизни.
...
d_b = {
text = [[*Импульс невероятной силы прилетел в твою сторону. Ты потерял равновесие и упал, задохнувшись. Существо же сказало только одно слово.*
Неуважение.]],
speaker = [[Зелёный]],
npc = "npc_green",
choices = {
...
d_k21 = {
text = [[Кролик быстро осознал, насколько ужасно это место. Он не мог вынести мысли, что кто-то тоже может оказаться в этой ловушке.]],
speaker = [[Сказитель]],
npc = "npc_storyteller",
choices = {
{
...
d_l1 = {
text = [[*Он пыхтит как паровоз. От невероятной концентрации на вашей дуэли его язык аж вывалился. Вот вот он потеряет сознание.*
1 монета!!!!!]],
speaker = [[Перекуп]],
npc = "npc_perekup",
choices = {
...
d_leader_again_1 = {
text = [[Чтобы открыть проход в Коралловый лес, подойди поближе к двери и произнеси заклинание вслух: "Stringus Collapsus".]],
speaker = [[Глава]],
npc = "npc_leader",
choices = {
{
...
d_r = {
text = [[Отличная работа. Было бы ужасно, если бы выяснилось, что путь до Дерека закрыт на ключ, ты бы проделал сложный путь в пустую.]],
speaker = [[Глава]],
npc = "npc_leader",
choices = {
{
...
d_r1 = {
text = [[Мы с тобой - два человека, которые жили и умерли на Земле, но по какой-то причине нам позволили остаться здесь. 
...
text = [[Я? Когда она ворвалась в Королевство, так я сразу с ноги в неё влетел, после чего мы сцепились. Была жёсткая битва! Однако поняв, что я ей не ровня, та просто сбежала в сторону леса.]],
speaker = [[Человек-усач]],
npc = "npc_mustache",
choices = {
{
...
text = [[*Он не предпринимает никаких действий, но ты замечаешь, как от напряжения, его тело начинает немного увеличиваться в размерах.*]],
speaker = [[Зелёный]],
npc = "npc_green",
choices = {
{
...
d_kakih_drugih = {
text = [[Части разных лесов соедины между собой вратами, которые я закрыл на печати, дабы опасные существа не пробирались в Королевство.]],
speaker = [[Глава]],
npc = "npc_leader",
choices = {
{
...
d_nu_tipo_da = {
text = [[Мне сообщили, что ты прибыл недавно, так что есть вещи, которые ты должен знать. Расклад сейчас такой: людей осталось мало, а враждебные крипы постоянно совершают убийства и грабежи. Мы не можем давать отпор.]],
speaker = [[Глава]],
npc = "npc_leader",
choices = {
{
...
text = [[*Уверенный в своих умениях перекуп одобрительно кивает. Его большая улыбка подразумевает, что он в этом деле про.*]],
speaker = [[Перекуп]],
npc = "npc_perekup",
choices = {
{
...
choices = {
{
text = [[И знаешь ли, мой кулак дробит камни, а тут передо мной глыба. Так что последний шанс пойти со мной.]],
next = "d_i_znaesh_li_moj_kulak_drobit_kamni_a_tut_peredo_mnoj_glyba_tak_chto_poslednij_shans_pojti_so_mnoj",
},
},
},
d_tupanul_nemnogo_napomni_a = {
text = [[*Он рассмеялся. Тебе стало неловко, но потом ты впитал ментальный урон и выпустил в виде пара. Из носа, конечно же.*
...
d_chto__2 = {
text = [[*У тебя участилось дыхание, воздух перестал поступать в лёгкие, но тебя это даже впирает. Ты всё ещё не можешь принять того, что видишь.*]],
speaker = [[...]],
npc = nil,
choices = {
{
...
text = [[*Ты осчастливил его, так пусть кайфует. Ты решаешься просто идти дальше. На этом ваши пути расходятся.*]],
speaker = [[Крип-нигер]],
npc = "npc_dream_golden",
choices = {
{
...
text = [[*Правильно думаешь. Чутьё подсказывает, что на острове находится что-то невероятно опасное, ОЧЕНЬ опасное. Лучше не идти туда, пока не будешь в прайме, ведь там будет невероятно сложно. Доверься своему разуму разочек.*]],
speaker = [[Кот-бочка]],
npc = "npc_cat_barrel",
choices = {
{
...
d_untitled_passage_27_merged_act3 = {
text = [[*Увидев тебя, пузатый крип начал кидать распальцовку. Его походка изменилась, он начал чувствовать.*]],
speaker = [[Крип с мечтой]],
npc = "npc_dream",
choices = {
{
...
d_untitled_passage_42_merged_act3 = {
text = [[*Гангстер останавливает тебя. Кухонные ножи в его руках выглядят забавно, но ты понимаешь, что один такой тычок и тебе конец.*
...
d_untitled_passage_54 = {
text = [[*Две демонические фигуры прямо перед тобой. Их тела отбрасывают странную тень, есть ощущение, что она двигается сама по себе.*
...
d_untitled_passage_62 = {
text = [[Смерть за смертью. Ты будешь верить, что шанс на победу существует, однако вскоре эта надежда утонет в отчаянии.]],
speaker = [[Демоны Тени]],
npc = "npc_island_demon",
choices = {
{
...
d_untitled_passage_63_merged_act3 = {
text = [[*Услышав шаги, учёный моментально вычислил, что идёшь именно ты, обратя внимание на звук, вес и плотность твоих шагов, относительно пола.*
...
d_n2 = {
text = [[После, из деревьев вышли какие-то фигуры и связали нас, бросив в клетку. Мы ничего не видели, однако уверены, там что-то важное.]],
speaker = [[Кот-бочка]],
npc = "npc_cat_barrel",
choices = {
{
...
d_s = {
text = [[*Насладившись процессом, учёный забирает камень и начинает полировать его наждачкой. После, протягивает это произведение исскуства к тебе.*
...
d_s2 = {
text = [[*Учёный окликает своего коллегу. Крип-алхимик подходит к чану и черпает рукой небольшое количество консистенции и передаёт алхимику поменьше, тому, что сидит на нём. Тот же, в свою очередь, элегантно придаёт ему форму.*]],
speaker = [[Учёный]],
npc = "npc_scientist",
choices = {
{
...
d_dumau_hvatit = {
text = [[*Сжав булки, ты создал небольшую вспышку, уничтожив Тень. Твоя душа настолько чиста и сильна, что ты одной лишь силой воли смог остановить перевоплощение в демона и сохранить свой рассудок.*]],
speaker = [[Демоны Тени]],
npc = "npc_island_demon",
choices = {
{
...
d_on_sobran = {
text = [[*Глава берёт ключ и начинает рассматривать. Похоже его заинтересовала его форма. Увидел ли он в ней что-то знакомое?*
...
d_respekt_vam = {
text = [[Хотел немного lean, да? Иди и возьми немного, расслабишься. Кстати, не забудь штаны приспустить, ну... или то, что у тебя на ногах, хах!]],
speaker = [[Гангстер]],
npc = "npc_gangster",
choices = {
{
...
d_schekotno = {
text = [[*Ты чувствуешь ненормальный прилив сил, что-то чёрное начало струиться по твоим венам, а очи твои покраснели.*]],
speaker = [[Демоны Тени]],
npc = "npc_island_demon",
choices = {
{
...
d_ya_serezno = {
text = [[*Гангстер достал косяк и сочно закурил. Прошла минута, потом две. Все молчали и ждали, пока он закончит. Ты решил последовать их примеру.*
...
d_untitled_passage_70_merged_act4 = {
text = [[*Перед тобой стоит грозный человек с рельефным, но израненным телом. Большое количество шрамов наводит на определённые мысли. Аура, которую он излучает, словно отталкивает тебя. Есть ощущение, что стены сжимаются.*]],
speaker = [[Дерек]],
npc = "npc_derek",
choices = {
{
...
d_g34 = {
text = [[В страхе перед его сущностью, я запер вход в то место. Даже представить не могу, что с ним сейчас...]],
speaker = [[Дерек]],
npc = "npc_derek",
choices = {
{
...
d_h33 = {
text = [[Был один очень странный день. Когда я возвращался с работы, то заметил, что куча людей просто исчезла, словно испарилась...]],
speaker = [[Дерек]],
npc = "npc_derek",
choices = {
{
...
d_s3 = {
text = [[*Она продолжила медитацию и полминуты сидела неподвижно, однако услышав твои шорохи и поняв, что ты всё ещё тут, продолжила говорить.*
...
d_s6 = {
text = [[Но в Королество пускали не всех, потому отвергнутые начали гнить здесь. За это мы и ненавидим людей Королевства.]],
speaker = [[Житель Пустоши]],
npc = "npc_wasteland",
choices = {
{
...
d_s7 = {
text = [[А когда толпа ваших людей ворвалась сюда с целью казнить Дерека, то мы, просто попрятались. Ты не представляешь сколько там было народу.]],
speaker = [[Житель Пустоши]],
npc = "npc_wasteland",
choices = {
{
...
d_s8 = {
text = [[И в тот момент мы решили, что пусть они делают своё дело. Хоть мы и враги, наша любовь к Королю - едина. Дерек совершил великий грех, он должен был умереть.]],
speaker = [[Житель Пустоши]],
npc = "npc_wasteland",
choices = {
{
...
d_s9 = {
text = [[Но он как-то выйграл... после чего стал тут жить. За всё время никто не осмелился сразиться с ним. Вот так и живём.]],
speaker = [[Житель Пустоши]],
npc = "npc_wasteland",
choices = {
{
...
d_t = {
text = [[Я надеялся, что его смерть дарует всем свободу. Однако ошибочно было полагать, что обычный человек способен противиться неизвестному.]],
speaker = [[Дерек]],
npc = "npc_derek",
choices = {
{
...
d_t5 = {
text = [[Я начал всем твердить, что Джордж что-то сделал с ними, но они были ему полностью преданны. Меня постоянно избивали и публично наказывали...]],
speaker = [[Дерек]],
npc = "npc_derek",
choices = {
{
...
d_t6 = {
text = [[В один день я решился пойти на убийство... Была надежда, что его смерть освободит разум людей от оков, однако… Думаю ты слышал, что, после этого, за мной устроили охоту.]],
speaker = [[Дерек]],
npc = "npc_derek",
choices = {
{
...
text = [[Сходи и убедись сам, если хочешь... Та пещера находится у входа в Королевство. Открывается она с помощью слов: "Carcer Immortalium"...]],
speaker = [[Дерек]],
npc = "npc_derek",
choices = {
{
...
d_esche_pytaeshsya = {
text = [[*Его пот начал становиться паром. Капилляры на глазах полопались. Корчась от боли, он встаёт, оперевшись на ноги и руки одновременно, словно животное. Невероятная воля к жизни даёт ему силы продолжать схватку.
Зверь пробудился.*]],
speaker = [[Дерек]],
npc = "npc_derek",
choices = {
...
text = [[ПРОДОЛЖАЙ МЕНЯ ВЕСЕЛИТЬ, ШУТ. Я ХОЧУ ЕЩЁ! СЕЙЧАС ВСПОЛЫХНУ, НЕ ПРЕДСТАВЛЯЕШЬ СКОЛЬКО Я ТОМИЛСЯ ЗДЕСЬ. ПОРА ПОКАЗАТЬ, ПОЧЕМУ МЕНЯ НАЗЫВАЮТ БОГОПОДОБНЫМ.]],
speaker = [[Пропавший Король]],
npc = "npc_george",
choices = {
{
...
d_o_chem_rech = {
text = [[ОО, ТЫ ЖЕ ОТКРЫЛ ДВЕРЬ. Я СВОБОДЕН. ОСТАЛОСЬ ТОЛЬКО ИЗБИТЬ ТЕБЯ, НО НЕ УБИВАТЬ. ВОЗМОЖНО ОН ДАСТ МНЕ ЕЩЁ ОДИН ШАНС.]],
speaker = [[Пропавший Король]],
npc = "npc_george",
choices = {
{
...
d_obratno_v_zhizn = {
text = [[*Она немного замешкалась, но вскоре поняла важность твоих слов и отправилась оповещать всех людей.*]],
speaker = [[...]],
npc = "npc_guide",
choices = {
{
...
d_prodolzhaj = {
text = [[И из ниоткуда пришёл человек и провозгласил себя королём. По какой-то причине все последовали за ним без вопросов, будто так всегда было...]],
speaker = [[Дерек]],
npc = "npc_derek",
choices = {
{
...
text = [[*Его удивлённый, но, в то же время, недвольный взгляд обрушился на тебя. Он воспринял это как провокацию.*
...
d_untitled_passage_46_merged_bubbles = {
text = [[Стой! Я с миром. Прошлое не заботит меня, все те конфликты между нами уже позади. Нужно наслаждаться тем, что мы всё ещё живы.]],
speaker = [[default]],
npc = "npc_courier_pig",
is_bubble = true,
choices = {
...
d_untitled_passage_53_merged_bubbles = {
text = [[Здесь мы отдыхаем. Умным необходимо место, где можно выпустить пар или расслабиться, присоединяйся.]],
speaker = [[default]],
