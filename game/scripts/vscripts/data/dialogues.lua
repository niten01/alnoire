...
return {
    ...
    nodes = {
        ...
        d_metnut_kamen_v_sooruzhenie = {
            text = [[*Твой бросок на что-то повлиял. Золотая фигура издала тихо затрещала.*]],
            speaker = [[...]],
            npc = "npc_tormentor",
            choices = {
                {
...
*Подзывает тебя, поддёргивая рукой.*]],
        ...
        d_untitled_passage_42 = {
            text =
            [[*Крип причудливой внешности излучает необычайное спокойствие. Его голова туго укатана синей тканью.*]],
            speaker = [[Огр-громила]],
            npc = "npc_ogre_bruiser",
            choices = {
                {
...
*Сказано это было спокойно и уверенно, без намёка на гнев. Он ждёт твоих действий.*]],
        ...
        d_o7 = {
            text =
            [[А?! Ты ещё здесь? Вообщем есть неурядица. Приходили крипочки-хулиганы и начали играть в футбол моим драгоценным шаром! Эти черти разбили его!]],
            speaker = [[Крип Предвестник]],
            npc = "npc_predvestnik",
            choices = {
                {
...
Зачем жителю Королевства вступать в наши земли? Вы же знаете, что тут только разруха, разбойничество и нищета.]],
        ...
        d_s9 = {
            text =
            [[Но он как-то выйграл... после чего стал тут жить. За всё время никто не осмелился сразиться с ним. Вот так и живём.]],
            speaker = [[Житель Пустоши]],
            npc = "npc_wasteland",
            choices = {
                {
