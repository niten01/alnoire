...
Мммм... Человеческое дитя, видать тебя послали из Королевства помочь мне?]],
        ...
        d_vzyat_nagradu = {
            text =
            [[Вот тебе следующее задание: собери все части ключа и почини с помощью алхимиков. После, возвращайся ко мне и всё обдумаем.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
Спасибо, спасибо!! Ты реально оу джи, кекс! Ты лучший!!]],
        ...
        d_leaderagain1 = {
            text =
            [[Чтобы открыть проход в Коралловый лес, подойди поближе к двери и произнеси заклинание вслух: "Stringus Colllapsus".]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
Здравствуй, Алекс.]],
        ...
        d_q1 = {
            text =
            [[Однако на смену солнцу всегда приходит луна. Однажды явился Зверь и безжалостно расстерзал нашего прекрасного Короля...
*У Главы пошла слеза.*]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
...
После, Дерек попросил сделать ещё одну вещь...  А именно: запереть его в древних покоях, что находятся на краю Пустоши.]],
        ...
        d_q3 = {
            text =
            [[...что загнанный в угол зверь - самый страшный противник. Почти все полегли. Только один человек смог сбежать, но вместо того, чтобы вернуться в Королевство, он ушёл в Снежные горы. Причину никто так и не знает...]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
Мои пятки были в крови и я просто застыл, однако Дерек не спешил нападать. Он... он просто остановился, начав глубоко дышать... Вдох... Выдох... Вдох.]],
        ...
        d_r1 = {
            text =
            [[Мы с тобой - два человека, которые жили и умерли на Земле, но по какой-то причине нам позволили остаться здесь. Так почему бы не сделать этот мир лучшим местом и не насладиться последними мгновениями жизни, что нам даровали?]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
Я не знаю.]],
        ...
        d_a_kak_ty_perezhil_s_nim_vstrechu = {
            text =
            [[Я? Когда она ворвалась в Королевство, так сразу с ноги в неё влетел, после чего мы сцепились. Была жёсткая битва! Однако, поняв, что я ей не ровня, просто сбежала в сторону леса.]],
            speaker = [[Человек-усач]],
            npc = "npc_mustache",
            choices = {
                {
...
*Он едва кивнул головой.*]],
        ...
        d_i_ty_poluchaetsya_pervyj_kto_podhvatilsya_da = {
            text =
            [[Взял инициативу. Но ты не подумай, у меня великие цели. Каждый день я тружусь во благо Королевства, поэтому приходится управлять всем из безопасности, ведь, если со мной что-то случится, всё рухнет.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
*Он оцепенел.*]],
        ...
        d_kakih_drugih = {
            text =
            [[Части разных лесов соедины между собой дверьми, которые я закрыл на печати, дабы опасные существа не пробирались в Королевство.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
Ну вот... Мне никогда не стать нигером...]],
        ...
        d_nu_tipo_da = {
            text =
            [[Расклад у нас сейчас такой: людей осталось мало, а враждебные крипы постоянно совершают убийства и грабежи. Мы не можем давать отпор.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
Нееет, я пожалуй тут останусь... И давай, чтоб ты не рисковал, я тебе за 140 отдам, а?]],
        ...
        d_prostite = {
            text =
            [[Впрочем уже поздно что-то менять. Если верить словам отшельника, первая часть ключа находятся у старушки, вторая – на одном из пиков Снежных гор, третью же оберегают челюсти чудовища Искаженного леса.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
Похож?! Реально похож?!]],
        ...
        d_ty_upomyanul_chto_zver_tebya_otpustil = {
            text =
            [[Да... Ту ночь я никогда не забуду. Люди умирали пачками, мои друзья бездыханно лежали под ногами, а моё тело зажималось и дрожало от страха.]],
            speaker = [[Человек-отшельник]],
            npc = "npc_hermit",
            choices = {
                {
...
*Глава говорит это с огромной гордостью.*]],
        ...
        d_ya_zabyl_gde_nahodyatsya_chasti_klucha = {
            text =
            [[Я начинаю думать, что твое присутствие в деревне – плод чьей-то нерассудительной щедрости. Кажется мой протеже поторопился, рассказывая тебе пароль.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
...
Чего белозадый забыл у нас? Проблем хочешь?]],
        ...
        d_untitled_passage_62 = {
            text =
            [[Смерть за смертью. Ты будешь верить, что есть шанс на победу, однако вскоре эта надежда утонет в отчаянии.]],
            speaker = [[Демоны-Тени]],
            npc = "npc_shadow_demon",
            choices = {
                {
        ...
        d_n2 = {
            text =
            [[После, из деревьев вышли какие-то люди и связали нас, бросив в клетку. Мы ничего не видели, однако уверены, там что-то важное.]],
            speaker = [[Кот-бочка]],
            npc = "npc_cat_barrel",
            choices = {
                {
...
Ооуоэъх... Ты всё увидишь, мой хоуми. Как всё прошло?]],
        ...
        d_s2 = {
            text =
            [[*Крип-алхимик черпает рукой небольшое количество консистенции и передаёт коллеге, который сидит на нём. Тот же, в свою очередь, элегантно придаёт ему форму.*]],
            speaker = [[Человек-учёный]],
            npc = "npc_scientist",
            choices = {
                {
...
Давай же, Исчадие тьмы, одолеем его ради нашего хозяина. Мы перед ним в неоплатном долгу.]],
        ...
        d_ne_ponyal_ya_odin_pojdu = {
            text =
            [[Подумай. Ты единолично одолел сильнейших существ этого мира, никто из людей и близко не доходил до такого уровня силы. Только ты способен избавить эту землю от чумы, именуемой Дереком.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
        ...
        d_prinimau = {
            text =
            [[Остаётся последний шаг - одолеть Зверя Пустоши. Отправляйся сейчас и прояви мужество на поле боя, борись до конца. Ради своего будущего, руди будущего Королевства.]],
            speaker = [[Глава]],
            npc = "npc_leader",
            choices = {
                {
