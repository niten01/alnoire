...
LinkLuaModifier('modifier_story_lethal_damage_tracking', 'modifiers/modifier_story_lethal_damage_tracking',
    LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier('modifier_story_weak_hit_tracking', 'modifiers/modifier_story_weak_hit_tracking',
    LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier('modifier_disabled_vis', 'modifiers/modifier_disabled_vis', LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_chaser_clone_ai", "modifiers/ai/modifier_chaser_clone_ai", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_chaser_final_ai", "modifiers/ai/modifier_chaser_final_ai", LUA_MODIFIER_MOTION_NONE)
