...
LinkLuaModifier("modifier_towel_summon_dash_knockback", "modifiers/abilities/modifier_towel_summon_dash_knockback",
...
function modifier_towel_summon_dash:UpdateHorizontalMotion(me, dt)
    ...
    self.speed = self.baseSpeed * (math.pow(self.timer, self.power))
